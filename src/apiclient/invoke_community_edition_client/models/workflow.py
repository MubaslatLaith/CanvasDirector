...
if TYPE_CHECKING:
    ...
    from ..models.workflow_edges_item import WorkflowEdgesItem
    from ..models.workflow_form_type_0 import WorkflowFormType0
    from ..models.workflow_meta import WorkflowMeta
    from ..models.workflow_nodes_item import WorkflowNodesItem
...
class Workflow:
    ...
    Attributes:
        ...
        meta (WorkflowMeta):
        nodes (list[WorkflowNodesItem]): The nodes of the workflow.
        edges (list[WorkflowEdgesItem]): The edges of the workflow.
        id (str): The id of the workflow.
        form (None | Unset | WorkflowFormType0): The form of the workflow.
    """
    ...
    meta: WorkflowMeta
    nodes: list[WorkflowNodesItem]
    edges: list[WorkflowEdgesItem]
    id: str
    form: None | Unset | WorkflowFormType0 = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.form, Unset):
            form = UNSET
        elif isinstance(self.form, WorkflowFormType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for nodes_item_data in _nodes:
            nodes_item = WorkflowNodesItem.from_dict(nodes_item_data)
        ...
        for edges_item_data in _edges:
            edges_item = WorkflowEdgesItem.from_dict(edges_item_data)

            edges.append(edges_item)

        id = d.pop("id")

        def _parse_form(data: object) -> None | Unset | WorkflowFormType0:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                form_type_0 = WorkflowFormType0.from_dict(data)

                return form_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | Unset | WorkflowFormType0, data)
