...
T = TypeVar("T", bound="Qwen3EncoderQwen3EncoderConfig")


@_attrs_define
class Qwen3EncoderQwen3EncoderConfig:
    ...
    compatible with Qwen2VLForConditionalGeneration or similar architectures used by Z-Image.
        ...
        Attributes:
            ...
            type_ (Literal['qwen3_encoder']):  Default: 'qwen3_encoder'.
            format_ (Literal['qwen3_encoder']):  Default: 'qwen3_encoder'.
            cpu_only (bool | None): Whether this model should run on CPU only
            variant (Qwen3VariantType): Qwen3 text encoder variants based on model size.
    """
    ...
    type_: Literal["qwen3_encoder"] = "qwen3_encoder"
    format_: Literal["qwen3_encoder"] = "qwen3_encoder"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["qwen3_encoder"], d.pop("type"))
        if type_ != "qwen3_encoder":
            raise ValueError(f"type must match const 'qwen3_encoder', got '{type_}'")

        format_ = cast(Literal["qwen3_encoder"], d.pop("format"))
        if format_ != "qwen3_encoder":
            raise ValueError(f"format must match const 'qwen3_encoder', got '{format_}'")
        ...
        variant = Qwen3VariantType(d.pop("variant"))

        qwen_3_encoder_qwen_3_encoder_config = cls(
            key=key,
            hash_=hash_,
            path=path,
            file_size=file_size,
        ...
        qwen_3_encoder_qwen_3_encoder_config.additional_properties = d
        return qwen_3_encoder_qwen_3_encoder_config
