...
T = TypeVar("T", bound="MultiplyImages")
...
class MultiplyImages:
    ...
    Attributes:
        ...
        type_ (Literal['img_mul']):  Default: 'img_mul'.
        ...
        image1 (ImageField | None | Unset): The first image to multiply
        image2 (ImageField | None | Unset): The second image to multiply
    """

    id: str
    type_: Literal["img_mul"] = "img_mul"
    board: BoardField | None | Unset = UNSET
    metadata: MetadataField | None | Unset = UNSET
    is_intermediate: bool | Unset = False
    use_cache: bool | Unset = True
    image1: ImageField | None | Unset = UNSET
    image2: ImageField | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        image1: dict[str, Any] | None | Unset
        if isinstance(self.image1, Unset):
            image1 = UNSET
        elif isinstance(self.image1, ImageField):
            image1 = self.image1.to_dict()
        else:
            image1 = self.image1

        image2: dict[str, Any] | None | Unset
        if isinstance(self.image2, Unset):
            image2 = UNSET
        elif isinstance(self.image2, ImageField):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["img_mul"], d.pop("type"))
        if type_ != "img_mul":
            raise ValueError(f"type must match const 'img_mul', got '{type_}'")
        ...
        def _parse_image1(data: object) -> ImageField | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                image1_type_0 = ImageField.from_dict(data)

                return image1_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(ImageField | None | Unset, data)

        image1 = _parse_image1(d.pop("image1", UNSET))

        def _parse_image2(data: object) -> ImageField | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                image2_type_0 = ImageField.from_dict(data)

                return image2_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(ImageField | None | Unset, data)

        image2 = _parse_image2(d.pop("image2", UNSET))
        ...
        multiply_images.additional_properties = d
