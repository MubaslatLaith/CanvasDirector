...
T = TypeVar("T", bound="ColorPrimitive")
...
class ColorPrimitive:
    ...
    Attributes:
        ...
        type_ (Literal['color']):  Default: 'color'.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        color_primitive.additional_properties = d
        return color_primitive
