...
from ..models.metadata_to_model_label import MetadataToModelLabel
...
T = TypeVar("T", bound="MetadataToModel")


@_attrs_define
class MetadataToModel:
    """Extracts a Model value of a label from metadata

    Attributes:
        id (str): The id of this instance of an invocation. Must be unique among all instances of invocations.
        type_ (Literal['metadata_to_model']):  Default: 'metadata_to_model'.
        metadata (MetadataField | None | Unset): Optional metadata to be saved with the image
        is_intermediate (bool | Unset): Whether or not this is an intermediate invocation. Default: False.
        use_cache (bool | Unset): Whether or not to use the cache Default: True.
        label (MetadataToModelLabel | Unset): Label for this metadata item Default: MetadataToModelLabel.MODEL.
        custom_label (None | str | Unset): Label for this metadata item
        default_value (ModelIdentifierField | None | Unset): The default model to use if not found in the metadata
    """

    id: str
    type_: Literal["metadata_to_model"] = "metadata_to_model"
    metadata: MetadataField | None | Unset = UNSET
    is_intermediate: bool | Unset = False
    use_cache: bool | Unset = True
    label: MetadataToModelLabel | Unset = MetadataToModelLabel.MODEL
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["metadata_to_model"], d.pop("type"))
        if type_ != "metadata_to_model":
            raise ValueError(f"type must match const 'metadata_to_model', got '{type_}'")
        ...
        label: MetadataToModelLabel | Unset
        if isinstance(_label, Unset):
            label = UNSET
        else:
            label = MetadataToModelLabel(_label)
        ...
        metadata_to_model.additional_properties = d
        return metadata_to_model
