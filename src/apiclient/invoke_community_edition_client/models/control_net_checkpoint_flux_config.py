...
T = TypeVar("T", bound="ControlNetCheckpointFLUXConfig")


@_attrs_define
class ControlNetCheckpointFLUXConfig:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        control_net_checkpoint_flux_config = cls(
            key=key,
            hash_=hash_,
            path=path,
            file_size=file_size,
        ...
        control_net_checkpoint_flux_config.additional_properties = d
        return control_net_checkpoint_flux_config
