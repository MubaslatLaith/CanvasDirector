...
T = TypeVar("T", bound="MainDiffusersFLUXConfig")


@_attrs_define
class MainDiffusersFLUXConfig:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        main_diffusers_flux_config = cls(
            key=key,
            hash_=hash_,
            path=path,
            file_size=file_size,
        ...
        main_diffusers_flux_config.additional_properties = d
        return main_diffusers_flux_config
