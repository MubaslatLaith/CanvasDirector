...
if TYPE_CHECKING:
    ...
    from ..models.starter_model_without_dependencies import StarterModelWithoutDependencies


T = TypeVar("T", bound="StarterModel")
...
class StarterModel:
    ...
    Attributes:
        ...
        dependencies (list[StarterModelWithoutDependencies] | None | Unset):
    """
    ...
    dependencies: list[StarterModelWithoutDependencies] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_dependencies(data: object) -> list[StarterModelWithoutDependencies] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for dependencies_type_0_item_data in _dependencies_type_0:
                    dependencies_type_0_item = StarterModelWithoutDependencies.from_dict(dependencies_type_0_item_data)
                ...
                pass
            return cast(list[StarterModelWithoutDependencies] | None | Unset, data)
        ...
        starter_model.additional_properties = d
