...
T = TypeVar("T", bound="TIFolderSD1Config")


@_attrs_define
class TIFolderSD1Config:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ti_folder_sd1_config.additional_properties = d
        return ti_folder_sd1_config
