...
T = TypeVar("T", bound="VAECheckpointFlux2Config")


@_attrs_define
class VAECheckpointFlux2Config:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        vae_checkpoint_flux_2_config = cls(
            key=key,
            hash_=hash_,
            path=path,
            file_size=file_size,
        ...
        vae_checkpoint_flux_2_config.additional_properties = d
        return vae_checkpoint_flux_2_config
