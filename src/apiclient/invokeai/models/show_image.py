...
class ShowImage:
    ...
    Attributes:
        ...
        type_ (Literal['show_image']):  Default: 'show_image'.
        is_intermediate (bool | Unset): Whether or not this is an intermediate invocation. Default: False.
        use_cache (bool | Unset): Whether or not to use the cache Default: True.
        image (ImageField | None | Unset): The image to show
    """

    id: str
    type_: Literal["show_image"] = "show_image"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["show_image"], d.pop("type"))
        if type_ != "show_image":
            raise ValueError(f"type must match const 'show_image', got '{type_}'")
        ...
        show_image.additional_properties = d
        return show_image
