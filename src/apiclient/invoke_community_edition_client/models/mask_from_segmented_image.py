...
T = TypeVar("T", bound="MaskFromSegmentedImage")


@_attrs_define
class MaskFromSegmentedImage:
    """Generate a mask for a particular color in an ID Map

    Attributes:
        id (str): The id of this instance of an invocation. Must be unique among all instances of invocations.
        type_ (Literal['mask_from_id']):  Default: 'mask_from_id'.
        ...
        image (ImageField | None | Unset): The image to create the mask from
        color (ColorField | None | Unset): ID color to mask
        threshold (int | Unset): Threshold for color detection Default: 100.
        invert (bool | Unset): Whether or not to invert the mask Default: False.
    """

    id: str
    type_: Literal["mask_from_id"] = "mask_from_id"
    board: BoardField | None | Unset = UNSET
    metadata: MetadataField | None | Unset = UNSET
    is_intermediate: bool | Unset = False
    use_cache: bool | Unset = True
    image: ImageField | None | Unset = UNSET
    color: ColorField | None | Unset = UNSET
    threshold: int | Unset = 100
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.color, Unset):
            color = UNSET
        elif isinstance(self.color, ColorField):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["mask_from_id"], d.pop("type"))
        if type_ != "mask_from_id":
            raise ValueError(f"type must match const 'mask_from_id', got '{type_}'")
        ...
        def _parse_color(data: object) -> ColorField | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                color_type_0 = ColorField.from_dict(data)

                return color_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(ColorField | None | Unset, data)
        ...
        mask_from_segmented_image.additional_properties = d
        return mask_from_segmented_image
