...
from ...models.body_update_workflow_is_public import BodyUpdateWorkflowIsPublic
...
def _get_kwargs(
    workflow_id: str,
    *,
    body: BodyUpdateWorkflowIsPublic,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/api/v1/workflows/i/{workflow_id}/is_public".format(
