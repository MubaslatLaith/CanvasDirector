...
T = TypeVar("T", bound="LatentsToImageQwenImage")


@_attrs_define
class LatentsToImageQwenImage:
    """Generates an image from latents using the Qwen Image VAE.

    Attributes:
        id (str): The id of this instance of an invocation. Must be unique among all instances of invocations.
        type_ (Literal['qwen_image_l2i']):  Default: 'qwen_image_l2i'.
    ...
    id: str
    type_: Literal["qwen_image_l2i"] = "qwen_image_l2i"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["qwen_image_l2i"], d.pop("type"))
        if type_ != "qwen_image_l2i":
            raise ValueError(f"type must match const 'qwen_image_l2i', got '{type_}'")
        ...
        latents_to_image_qwen_image = cls(
            id=id,
            type_=type_,
            board=board,
            metadata=metadata,
        ...
        latents_to_image_qwen_image.additional_properties = d
        return latents_to_image_qwen_image
