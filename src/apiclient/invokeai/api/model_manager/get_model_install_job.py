...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v2/models/install/{id}".format(
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = ModelInstallJob.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    """Get Model Install Job
     ...
     Return model install job corresponding to the given source. See the documentation for 'List Model
    Install Jobs'
    for information on the format of the return value.

    Args:
        id (int): Model install id
