...
T = TypeVar("T", bound="CropImageToBoundingBox")


@_attrs_define
class CropImageToBoundingBox:
    """Crop an image to the given bounding box. If the bounding box is omitted, the image is cropped to the non-transparent
    pixels.

        Attributes:
            id (str): The id of this instance of an invocation. Must be unique among all instances of invocations.
            type_ (Literal['crop_image_to_bounding_box']):  Default: 'crop_image_to_bounding_box'.
            ...
            bounding_box (BoundingBoxField | None | Unset): The bounding box to crop the image to
    """

    id: str
    type_: Literal["crop_image_to_bounding_box"] = "crop_image_to_bounding_box"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["crop_image_to_bounding_box"], d.pop("type"))
        if type_ != "crop_image_to_bounding_box":
            raise ValueError(f"type must match const 'crop_image_to_bounding_box', got '{type_}'")
        ...
        crop_image_to_bounding_box = cls(
            id=id,
            type_=type_,
            board=board,
            metadata=metadata,
        ...
        crop_image_to_bounding_box.additional_properties = d
        return crop_image_to_bounding_box
