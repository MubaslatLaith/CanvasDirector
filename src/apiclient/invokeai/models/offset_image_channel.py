...
from ..models.offset_image_channel_channel_type_0 import OffsetImageChannelChannelType0
...
T = TypeVar("T", bound="OffsetImageChannel")


@_attrs_define
class OffsetImageChannel:
    """Add or subtract a value from a specific color channel of an image.

    Attributes:
        id (str): The id of this instance of an invocation. Must be unique among all instances of invocations.
        type_ (Literal['img_channel_offset']):  Default: 'img_channel_offset'.
        ...
        channel (None | OffsetImageChannelChannelType0 | Unset): Which channel to adjust
        offset (int | Unset): The amount to adjust the channel by Default: 0.
    """

    id: str
    type_: Literal["img_channel_offset"] = "img_channel_offset"
    board: BoardField | None | Unset = UNSET
    metadata: MetadataField | None | Unset = UNSET
    is_intermediate: bool | Unset = False
    use_cache: bool | Unset = True
    image: ImageField | None | Unset = UNSET
    channel: None | OffsetImageChannelChannelType0 | Unset = UNSET
    offset: int | Unset = 0
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.channel, Unset):
            channel = UNSET
        elif isinstance(self.channel, OffsetImageChannelChannelType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["img_channel_offset"], d.pop("type"))
        if type_ != "img_channel_offset":
            raise ValueError(f"type must match const 'img_channel_offset', got '{type_}'")
        ...
        def _parse_channel(data: object) -> None | OffsetImageChannelChannelType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                channel_type_0 = OffsetImageChannelChannelType0(data)

                return channel_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | OffsetImageChannelChannelType0 | Unset, data)

        channel = _parse_channel(d.pop("channel", UNSET))

        offset = d.pop("offset", UNSET)

        offset_image_channel = cls(
            id=id,
            type_=type_,
            board=board,
            metadata=metadata,
        ...
        offset_image_channel.additional_properties = d
        return offset_image_channel
