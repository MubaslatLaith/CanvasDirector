...
T = TypeVar("T", bound="EquivalentAchromaticLightness")


@_attrs_define
class EquivalentAchromaticLightness:
    """Calculate Equivalent Achromatic Lightness from image. Originally created by @dwringer

    Attributes:
        id (str): The id of this instance of an invocation. Must be unique among all instances of invocations.
        type_ (Literal['invokeai_ealightness']):  Default: 'invokeai_ealightness'.
        ...
        image (ImageField | None | Unset): Image from which to get channel
    """

    id: str
    type_: Literal["invokeai_ealightness"] = "invokeai_ealightness"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["invokeai_ealightness"], d.pop("type"))
        if type_ != "invokeai_ealightness":
            raise ValueError(f"type must match const 'invokeai_ealightness', got '{type_}'")
        ...
        equivalent_achromatic_lightness = cls(
            id=id,
            type_=type_,
            board=board,
            metadata=metadata,
        ...
        equivalent_achromatic_lightness.additional_properties = d
        return equivalent_achromatic_lightness
