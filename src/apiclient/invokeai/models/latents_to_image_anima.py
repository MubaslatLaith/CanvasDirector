...
T = TypeVar("T", bound="LatentsToImageAnima")


@_attrs_define
class LatentsToImageAnima:
    ...
    latent denormalization, and FLUX VAE as fallback.
        ...
        Attributes:
            ...
            type_ (Literal['anima_l2i']):  Default: 'anima_l2i'.
    ...
    id: str
    type_: Literal["anima_l2i"] = "anima_l2i"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["anima_l2i"], d.pop("type"))
        if type_ != "anima_l2i":
            raise ValueError(f"type must match const 'anima_l2i', got '{type_}'")
        ...
        latents_to_image_anima.additional_properties = d
        return latents_to_image_anima
