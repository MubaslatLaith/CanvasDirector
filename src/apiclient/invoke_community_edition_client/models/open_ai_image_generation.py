...
from ..models.open_ai_image_generation_background import OpenAIImageGenerationBackground
from ..models.open_ai_image_generation_input_fidelity_type_0 import OpenAIImageGenerationInputFidelityType0
from ..models.open_ai_image_generation_mode import OpenAIImageGenerationMode
from ..models.open_ai_image_generation_quality import OpenAIImageGenerationQuality
...
T = TypeVar("T", bound="OpenAIImageGeneration")
...
class OpenAIImageGeneration:
    ...
    Attributes:
        ...
        type_ (Literal['openai_image_generation']):  Default: 'openai_image_generation'.
        ...
        mode (OpenAIImageGenerationMode | Unset): Generation mode. Default: OpenAIImageGenerationMode.TXT2IMG.
        ...
        init_image (ImageField | None | Unset): Init image (use reference_images instead)
        mask_image (ImageField | None | Unset): Mask image for inpaint
        reference_images (list[ImageField] | Unset): Reference images
        quality (OpenAIImageGenerationQuality | Unset): Output image quality Default: OpenAIImageGenerationQuality.AUTO.
        background (OpenAIImageGenerationBackground | Unset): Background transparency handling Default:
            OpenAIImageGenerationBackground.AUTO.
        input_fidelity (None | OpenAIImageGenerationInputFidelityType0 | Unset): Fidelity to source images (edits only)
    """

    id: str
    type_: Literal["openai_image_generation"] = "openai_image_generation"
    ...
    mode: OpenAIImageGenerationMode | Unset = OpenAIImageGenerationMode.TXT2IMG
    ...
    quality: OpenAIImageGenerationQuality | Unset = OpenAIImageGenerationQuality.AUTO
    background: OpenAIImageGenerationBackground | Unset = OpenAIImageGenerationBackground.AUTO
    input_fidelity: None | OpenAIImageGenerationInputFidelityType0 | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        input_fidelity: None | str | Unset
        if isinstance(self.input_fidelity, Unset):
            input_fidelity = UNSET
        elif isinstance(self.input_fidelity, OpenAIImageGenerationInputFidelityType0):
        ...
        if input_fidelity is not UNSET:
            field_dict["input_fidelity"] = input_fidelity
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["openai_image_generation"], d.pop("type"))
        if type_ != "openai_image_generation":
            raise ValueError(f"type must match const 'openai_image_generation', got '{type_}'")
        ...
        mode: OpenAIImageGenerationMode | Unset
        if isinstance(_mode, Unset):
            mode = UNSET
        else:
            mode = OpenAIImageGenerationMode(_mode)
        ...
        quality: OpenAIImageGenerationQuality | Unset
        if isinstance(_quality, Unset):
            quality = UNSET
        else:
            quality = OpenAIImageGenerationQuality(_quality)

        _background = d.pop("background", UNSET)
        background: OpenAIImageGenerationBackground | Unset
        if isinstance(_background, Unset):
            background = UNSET
        else:
            background = OpenAIImageGenerationBackground(_background)

        def _parse_input_fidelity(data: object) -> None | OpenAIImageGenerationInputFidelityType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                input_fidelity_type_0 = OpenAIImageGenerationInputFidelityType0(data)

                return input_fidelity_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | OpenAIImageGenerationInputFidelityType0 | Unset, data)

        input_fidelity = _parse_input_fidelity(d.pop("input_fidelity", UNSET))

        open_ai_image_generation = cls(
            id=id,
            type_=type_,
            board=board,
            metadata=metadata,
        ...
        open_ai_image_generation.additional_properties = d
        return open_ai_image_generation
