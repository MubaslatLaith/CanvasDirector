...
T = TypeVar("T", bound="ApplyLoRACollectionAnima")


@_attrs_define
class ApplyLoRACollectionAnima:
    """Applies a collection of LoRAs to an Anima transformer.

    Attributes:
        id (str): The id of this instance of an invocation. Must be unique among all instances of invocations.
        type_ (Literal['anima_lora_collection_loader']):  Default: 'anima_lora_collection_loader'.
    ...
    id: str
    type_: Literal["anima_lora_collection_loader"] = "anima_lora_collection_loader"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["anima_lora_collection_loader"], d.pop("type"))
        if type_ != "anima_lora_collection_loader":
            raise ValueError(f"type must match const 'anima_lora_collection_loader', got '{type_}'")
        ...
        apply_lo_ra_collection_anima = cls(
            id=id,
            type_=type_,
        ...
        apply_lo_ra_collection_anima.additional_properties = d
        return apply_lo_ra_collection_anima
