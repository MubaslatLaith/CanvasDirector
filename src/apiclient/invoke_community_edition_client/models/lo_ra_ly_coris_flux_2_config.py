...
T = TypeVar("T", bound="LoRALyCORISFlux2Config")


@_attrs_define
class LoRALyCORISFlux2Config:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        lo_ra_ly_coris_flux_2_config = cls(
            key=key,
            hash_=hash_,
            path=path,
            file_size=file_size,
        ...
        lo_ra_ly_coris_flux_2_config.additional_properties = d
        return lo_ra_ly_coris_flux_2_config
