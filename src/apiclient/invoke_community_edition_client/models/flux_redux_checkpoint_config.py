...
T = TypeVar("T", bound="FLUXReduxCheckpointConfig")


@_attrs_define
class FLUXReduxCheckpointConfig:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        flux_redux_checkpoint_config = cls(
            key=key,
            hash_=hash_,
            path=path,
            file_size=file_size,
        ...
        flux_redux_checkpoint_config.additional_properties = d
        return flux_redux_checkpoint_config
