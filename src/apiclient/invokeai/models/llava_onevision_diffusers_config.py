...
T = TypeVar("T", bound="LlavaOnevisionDiffusersConfig")


@_attrs_define
class LlavaOnevisionDiffusersConfig:
    ...
    Attributes:
        ...
        type_ (Literal['llava_onevision']):  Default: 'llava_onevision'.
    ...
    type_: Literal["llava_onevision"] = "llava_onevision"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["llava_onevision"], d.pop("type"))
        if type_ != "llava_onevision":
            raise ValueError(f"type must match const 'llava_onevision', got '{type_}'")
        ...
        llava_onevision_diffusers_config = cls(
            key=key,
            hash_=hash_,
            path=path,
            file_size=file_size,
        ...
        llava_onevision_diffusers_config.additional_properties = d
        return llava_onevision_diffusers_config
