...
T = TypeVar("T", bound="MainModelSD15SD2")


@_attrs_define
class MainModelSD15SD2:
    """Loads a main model, outputting its submodels.

    Attributes:
        id (str): The id of this instance of an invocation. Must be unique among all instances of invocations.
        type_ (Literal['main_model_loader']):  Default: 'main_model_loader'.
    ...
    id: str
    type_: Literal["main_model_loader"] = "main_model_loader"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["main_model_loader"], d.pop("type"))
        if type_ != "main_model_loader":
            raise ValueError(f"type must match const 'main_model_loader', got '{type_}'")
        ...
        main_model_sd15sd2.additional_properties = d
        return main_model_sd15sd2
