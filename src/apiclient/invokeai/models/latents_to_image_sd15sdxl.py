...
T = TypeVar("T", bound="LatentsToImageSD15SDXL")


@_attrs_define
class LatentsToImageSD15SDXL:
    """Generates an image from latents.

    Attributes:
        id (str): The id of this instance of an invocation. Must be unique among all instances of invocations.
        type_ (Literal['l2i']):  Default: 'l2i'.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["l2i"], d.pop("type"))
        if type_ != "l2i":
            raise ValueError(f"type must match const 'l2i', got '{type_}'")
        ...
        latents_to_image_sd15sdxl.additional_properties = d
        return latents_to_image_sd15sdxl
