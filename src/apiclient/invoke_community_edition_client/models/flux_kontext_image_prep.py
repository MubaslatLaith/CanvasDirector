...
T = TypeVar("T", bound="FLUXKontextImagePrep")


@_attrs_define
class FLUXKontextImagePrep:
    ...
    preferred Kontext resolution. All other images are concatenated horizontally, maintaining their aspect ratio.
        ...
        Attributes:
            ...
            type_ (Literal['flux_kontext_image_prep']):  Default: 'flux_kontext_image_prep'.
            ...
            images (list[ImageField] | None | Unset): The images to concatenate
            use_preferred_resolution (bool | Unset): Use FLUX preferred resolutions for the first image Default: True.
    """

    id: str
    type_: Literal["flux_kontext_image_prep"] = "flux_kontext_image_prep"
    ...
    use_preferred_resolution: bool | Unset = True
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        use_preferred_resolution = self.use_preferred_resolution
        ...
        if use_preferred_resolution is not UNSET:
            field_dict["use_preferred_resolution"] = use_preferred_resolution
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["flux_kontext_image_prep"], d.pop("type"))
        if type_ != "flux_kontext_image_prep":
            raise ValueError(f"type must match const 'flux_kontext_image_prep', got '{type_}'")
        ...
        use_preferred_resolution = d.pop("use_preferred_resolution", UNSET)

        flux_kontext_image_prep = cls(
            id=id,
            type_=type_,
            board=board,
            metadata=metadata,
            ...
            use_cache=use_cache,
            images=images,
            use_preferred_resolution=use_preferred_resolution,
        )

        flux_kontext_image_prep.additional_properties = d
        return flux_kontext_image_prep
