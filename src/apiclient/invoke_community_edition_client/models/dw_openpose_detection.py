...
T = TypeVar("T", bound="DWOpenposeDetection")


@_attrs_define
class DWOpenposeDetection:
    """Generates an openpose pose from an image using DWPose

    Attributes:
        id (str): The id of this instance of an invocation. Must be unique among all instances of invocations.
        type_ (Literal['dw_openpose_detection']):  Default: 'dw_openpose_detection'.
        ...
        draw_body (bool | Unset):  Default: True.
        draw_face (bool | Unset):  Default: False.
        draw_hands (bool | Unset):  Default: False.
    """

    id: str
    type_: Literal["dw_openpose_detection"] = "dw_openpose_detection"
    board: BoardField | None | Unset = UNSET
    metadata: MetadataField | None | Unset = UNSET
    is_intermediate: bool | Unset = False
    use_cache: bool | Unset = True
    image: ImageField | None | Unset = UNSET
    draw_body: bool | Unset = True
    draw_face: bool | Unset = False
    draw_hands: bool | Unset = False
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if draw_body is not UNSET:
            field_dict["draw_body"] = draw_body
        if draw_face is not UNSET:
            field_dict["draw_face"] = draw_face
        if draw_hands is not UNSET:
            field_dict["draw_hands"] = draw_hands
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["dw_openpose_detection"], d.pop("type"))
        if type_ != "dw_openpose_detection":
            raise ValueError(f"type must match const 'dw_openpose_detection', got '{type_}'")
        ...
        draw_body = d.pop("draw_body", UNSET)

        draw_face = d.pop("draw_face", UNSET)

        draw_hands = d.pop("draw_hands", UNSET)

        dw_openpose_detection = cls(
            id=id,
            type_=type_,
            board=board,
            metadata=metadata,
        ...
        dw_openpose_detection.additional_properties = d
        return dw_openpose_detection
