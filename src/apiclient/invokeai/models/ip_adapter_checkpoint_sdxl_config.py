...
T = TypeVar("T", bound="IPAdapterCheckpointSDXLConfig")


@_attrs_define
class IPAdapterCheckpointSDXLConfig:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ip_adapter_checkpoint_sdxl_config = cls(
            key=key,
            hash_=hash_,
            path=path,
            file_size=file_size,
        ...
        ip_adapter_checkpoint_sdxl_config.additional_properties = d
        return ip_adapter_checkpoint_sdxl_config
