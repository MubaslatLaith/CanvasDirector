...
T = TypeVar("T", bound="T5EncoderBnBLLMint8Config")


@_attrs_define
class T5EncoderBnBLLMint8Config:
    ...
    Attributes:
        ...
        type_ (Literal['t5_encoder']):  Default: 't5_encoder'.
        format_ (Literal['bnb_quantized_int8b']):  Default: 'bnb_quantized_int8b'.
    ...
    type_: Literal["t5_encoder"] = "t5_encoder"
    format_: Literal["bnb_quantized_int8b"] = "bnb_quantized_int8b"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["t5_encoder"], d.pop("type"))
        if type_ != "t5_encoder":
            raise ValueError(f"type must match const 't5_encoder', got '{type_}'")

        format_ = cast(Literal["bnb_quantized_int8b"], d.pop("format"))
        if format_ != "bnb_quantized_int8b":
            raise ValueError(f"format must match const 'bnb_quantized_int8b', got '{format_}'")
        ...
        t5_encoder_bn_bll_mint_8_config = cls(
            key=key,
            hash_=hash_,
            path=path,
            file_size=file_size,
        ...
        t5_encoder_bn_bll_mint_8_config.additional_properties = d
        return t5_encoder_bn_bll_mint_8_config
