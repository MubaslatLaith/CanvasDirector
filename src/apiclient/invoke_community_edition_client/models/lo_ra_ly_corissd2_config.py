...
T = TypeVar("T", bound="LoRALyCORISSD2Config")


@_attrs_define
class LoRALyCORISSD2Config:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        lo_ra_ly_corissd2_config.additional_properties = d
        return lo_ra_ly_corissd2_config
