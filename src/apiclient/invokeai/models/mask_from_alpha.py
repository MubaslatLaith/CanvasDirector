...
T = TypeVar("T", bound="MaskFromAlpha")
...
class MaskFromAlpha:
    ...
    Attributes:
        ...
        type_ (Literal['tomask']):  Default: 'tomask'.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["tomask"], d.pop("type"))
        if type_ != "tomask":
            raise ValueError(f"type must match const 'tomask', got '{type_}'")
        ...
        mask_from_alpha.additional_properties = d
        return mask_from_alpha
