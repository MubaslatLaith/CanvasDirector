...
if TYPE_CHECKING:
    ...
    from ..models.progress_image import ProgressImage
...
T = TypeVar("T", bound="InvocationProgressEvent")


@_attrs_define
class InvocationProgressEvent:
    ...
    Attributes:
        ...
        percentage (float | None): The percentage of the progress (omit to indicate indeterminate progress)
        image (None | ProgressImage): An image representing the current state of the progress
    """
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.image, ProgressImage):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_percentage(data: object) -> float | None:
            if data is None:
                return data
        ...
        def _parse_image(data: object) -> None | ProgressImage:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                image_type_0 = ProgressImage.from_dict(data)

                return image_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | ProgressImage, data)

        image = _parse_image(d.pop("image"))

        invocation_progress_event = cls(
            timestamp=timestamp,
            queue_id=queue_id,
            item_id=item_id,
            batch_id=batch_id,
        ...
        invocation_progress_event.additional_properties = d
        return invocation_progress_event
