...
T = TypeVar("T", bound="PromptZImage")
...
class PromptZImage:
    ...
    Supports regional prompting by connecting a mask input.
        ...
        Attributes:
            ...
            type_ (Literal['z_image_text_encoder']):  Default: 'z_image_text_encoder'.
    ...
    id: str
    type_: Literal["z_image_text_encoder"] = "z_image_text_encoder"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["z_image_text_encoder"], d.pop("type"))
        if type_ != "z_image_text_encoder":
            raise ValueError(f"type must match const 'z_image_text_encoder', got '{type_}'")
        ...
        prompt_z_image.additional_properties = d
        return prompt_z_image
