...
T = TypeVar("T", bound="HEDEdgeDetection")
...
class HEDEdgeDetection:
    ...
    Attributes:
        ...
        type_ (Literal['hed_edge_detection']):  Default: 'hed_edge_detection'.
    ...
    id: str
    type_: Literal["hed_edge_detection"] = "hed_edge_detection"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["hed_edge_detection"], d.pop("type"))
        if type_ != "hed_edge_detection":
            raise ValueError(f"type must match const 'hed_edge_detection', got '{type_}'")
        ...
        hed_edge_detection.additional_properties = d
        return hed_edge_detection
