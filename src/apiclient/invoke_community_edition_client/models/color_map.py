...
class ColorMap:
    ...
    Attributes:
        ...
        type_ (Literal['color_map']):  Default: 'color_map'.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["color_map"], d.pop("type"))
        if type_ != "color_map":
            raise ValueError(f"type must match const 'color_map', got '{type_}'")
        ...
        color_map.additional_properties = d
        return color_map
