...
T = TypeVar("T", bound="ControlNetCheckpointSD1Config")


@_attrs_define
class ControlNetCheckpointSD1Config:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        control_net_checkpoint_sd1_config = cls(
            key=key,
            hash_=hash_,
            path=path,
            file_size=file_size,
        ...
        control_net_checkpoint_sd1_config.additional_properties = d
        return control_net_checkpoint_sd1_config
