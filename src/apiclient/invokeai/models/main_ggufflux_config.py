...
T = TypeVar("T", bound="MainGGUFFLUXConfig")


@_attrs_define
class MainGGUFFLUXConfig:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        main_ggufflux_config.additional_properties = d
        return main_ggufflux_config
