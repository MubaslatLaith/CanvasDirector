...
T = TypeVar("T", bound="ImageToLatentsAnima")


@_attrs_define
class ImageToLatentsAnima:
    """Generates latents from an image using the Anima VAE (supports Wan 2.1 and FLUX VAE).

    Attributes:
        id (str): The id of this instance of an invocation. Must be unique among all instances of invocations.
        type_ (Literal['anima_i2l']):  Default: 'anima_i2l'.
    ...
    id: str
    type_: Literal["anima_i2l"] = "anima_i2l"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["anima_i2l"], d.pop("type"))
        if type_ != "anima_i2l":
            raise ValueError(f"type must match const 'anima_i2l', got '{type_}'")
        ...
        image_to_latents_anima.additional_properties = d
        return image_to_latents_anima
