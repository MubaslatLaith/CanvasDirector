...
T = TypeVar("T", bound="LatentsToImageFLUX")


@_attrs_define
class LatentsToImageFLUX:
    """Generates an image from latents.

    Attributes:
        id (str): The id of this instance of an invocation. Must be unique among all instances of invocations.
        type_ (Literal['flux_vae_decode']):  Default: 'flux_vae_decode'.
    ...
    id: str
    type_: Literal["flux_vae_decode"] = "flux_vae_decode"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["flux_vae_decode"], d.pop("type"))
        if type_ != "flux_vae_decode":
            raise ValueError(f"type must match const 'flux_vae_decode', got '{type_}'")
        ...
        latents_to_image_flux.additional_properties = d
        return latents_to_image_flux
