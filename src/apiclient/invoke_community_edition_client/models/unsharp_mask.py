...
class UnsharpMask:
    ...
    Attributes:
        ...
        type_ (Literal['unsharp_mask']):  Default: 'unsharp_mask'.
    ...
    id: str
    type_: Literal["unsharp_mask"] = "unsharp_mask"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["unsharp_mask"], d.pop("type"))
        if type_ != "unsharp_mask":
            raise ValueError(f"type must match const 'unsharp_mask', got '{type_}'")
        ...
        unsharp_mask.additional_properties = d
        return unsharp_mask
