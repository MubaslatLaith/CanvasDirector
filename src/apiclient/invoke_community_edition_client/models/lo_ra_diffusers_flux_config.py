...
T = TypeVar("T", bound="LoRADiffusersFLUXConfig")


@_attrs_define
class LoRADiffusersFLUXConfig:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        lo_ra_diffusers_flux_config = cls(
            key=key,
            hash_=hash_,
            path=path,
            file_size=file_size,
        ...
        lo_ra_diffusers_flux_config.additional_properties = d
        return lo_ra_diffusers_flux_config
