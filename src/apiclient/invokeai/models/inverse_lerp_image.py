...
T = TypeVar("T", bound="InverseLerpImage")


@_attrs_define
class InverseLerpImage:
    """Inverse linear interpolation of all pixels of an image

    Attributes:
        id (str): The id of this instance of an invocation. Must be unique among all instances of invocations.
        type_ (Literal['img_ilerp']):  Default: 'img_ilerp'.
        ...
        image (ImageField | None | Unset): The image to lerp
        min_ (int | Unset): The minimum input value Default: 0.
        max_ (int | Unset): The maximum input value Default: 255.
    """

    id: str
    type_: Literal["img_ilerp"] = "img_ilerp"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["img_ilerp"], d.pop("type"))
        if type_ != "img_ilerp":
            raise ValueError(f"type must match const 'img_ilerp', got '{type_}'")
        ...
        inverse_lerp_image.additional_properties = d
        return inverse_lerp_image
