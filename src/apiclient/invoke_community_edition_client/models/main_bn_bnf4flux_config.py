...
T = TypeVar("T", bound="MainBnBNF4FLUXConfig")


@_attrs_define
class MainBnBNF4FLUXConfig:
    ...
    Attributes:
        ...
        format_ (Literal['bnb_quantized_nf4b']):  Default: 'bnb_quantized_nf4b'.
        variant (FluxVariantType): FLUX.1 model variants.
    """
    ...
    format_: Literal["bnb_quantized_nf4b"] = "bnb_quantized_nf4b"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        format_ = cast(Literal["bnb_quantized_nf4b"], d.pop("format"))
        if format_ != "bnb_quantized_nf4b":
            raise ValueError(f"format must match const 'bnb_quantized_nf4b', got '{format_}'")

        variant = FluxVariantType(d.pop("variant"))

        main_bn_bnf4flux_config = cls(
            key=key,
            hash_=hash_,
            path=path,
            file_size=file_size,
        ...
        main_bn_bnf4flux_config.additional_properties = d
        return main_bn_bnf4flux_config
