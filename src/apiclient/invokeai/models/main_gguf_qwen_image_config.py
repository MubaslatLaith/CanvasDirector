...
T = TypeVar("T", bound="MainGGUFQwenImageConfig")


@_attrs_define
class MainGGUFQwenImageConfig:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        main_gguf_qwen_image_config = cls(
            key=key,
            hash_=hash_,
            path=path,
            file_size=file_size,
        ...
        main_gguf_qwen_image_config.additional_properties = d
        return main_gguf_qwen_image_config
