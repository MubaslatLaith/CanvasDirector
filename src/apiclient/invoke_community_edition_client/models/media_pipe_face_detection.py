...
T = TypeVar("T", bound="MediaPipeFaceDetection")
...
class MediaPipeFaceDetection:
    ...
    Attributes:
        ...
        type_ (Literal['mediapipe_face_detection']):  Default: 'mediapipe_face_detection'.
        ...
        max_faces (int | Unset): Maximum number of faces to detect Default: 1.
        min_confidence (float | Unset): Minimum confidence for face detection Default: 0.5.
    """

    id: str
    type_: Literal["mediapipe_face_detection"] = "mediapipe_face_detection"
    board: BoardField | None | Unset = UNSET
    metadata: MetadataField | None | Unset = UNSET
    is_intermediate: bool | Unset = False
    use_cache: bool | Unset = True
    image: ImageField | None | Unset = UNSET
    max_faces: int | Unset = 1
    min_confidence: float | Unset = 0.5
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if max_faces is not UNSET:
            field_dict["max_faces"] = max_faces
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["mediapipe_face_detection"], d.pop("type"))
        if type_ != "mediapipe_face_detection":
            raise ValueError(f"type must match const 'mediapipe_face_detection', got '{type_}'")
        ...
        max_faces = d.pop("max_faces", UNSET)

        min_confidence = d.pop("min_confidence", UNSET)

        media_pipe_face_detection = cls(
            id=id,
            type_=type_,
            board=board,
            metadata=metadata,
        ...
        media_pipe_face_detection.additional_properties = d
        return media_pipe_face_detection
