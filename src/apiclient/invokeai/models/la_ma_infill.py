...
class LaMaInfill:
    ...
    Attributes:
        ...
        type_ (Literal['infill_lama']):  Default: 'infill_lama'.
    ...
    id: str
    type_: Literal["infill_lama"] = "infill_lama"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["infill_lama"], d.pop("type"))
        if type_ != "infill_lama":
            raise ValueError(f"type must match const 'infill_lama', got '{type_}'")
        ...
        la_ma_infill.additional_properties = d
        return la_ma_infill
