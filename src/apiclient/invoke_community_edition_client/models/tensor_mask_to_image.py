...
T = TypeVar("T", bound="TensorMaskToImage")


@_attrs_define
class TensorMaskToImage:
    """Convert a mask tensor to an image.

    Attributes:
        id (str): The id of this instance of an invocation. Must be unique among all instances of invocations.
        type_ (Literal['tensor_mask_to_image']):  Default: 'tensor_mask_to_image'.
        ...
        mask (None | TensorField | Unset): The mask tensor to convert.
    """

    id: str
    type_: Literal["tensor_mask_to_image"] = "tensor_mask_to_image"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["tensor_mask_to_image"], d.pop("type"))
        if type_ != "tensor_mask_to_image":
            raise ValueError(f"type must match const 'tensor_mask_to_image', got '{type_}'")
        ...
        tensor_mask_to_image.additional_properties = d
        return tensor_mask_to_image
