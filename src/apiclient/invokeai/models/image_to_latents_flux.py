...
T = TypeVar("T", bound="ImageToLatentsFLUX")


@_attrs_define
class ImageToLatentsFLUX:
    """Encodes an image into latents.

    Attributes:
        id (str): The id of this instance of an invocation. Must be unique among all instances of invocations.
        type_ (Literal['flux_vae_encode']):  Default: 'flux_vae_encode'.
    ...
    id: str
    type_: Literal["flux_vae_encode"] = "flux_vae_encode"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["flux_vae_encode"], d.pop("type"))
        if type_ != "flux_vae_encode":
            raise ValueError(f"type must match const 'flux_vae_encode', got '{type_}'")
        ...
        image_to_latents_flux.additional_properties = d
        return image_to_latents_flux
