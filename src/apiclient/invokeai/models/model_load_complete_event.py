...
T = TypeVar("T", bound="ModelLoadCompleteEvent")


@_attrs_define
class ModelLoadCompleteEvent:
    ...
    Attributes:
        ...
        config (CLIPEmbedDiffusersGConfig | CLIPEmbedDiffusersLConfig | CLIPVisionDiffusersConfig |
            ...
            VAEDiffusersSD1Config | VAEDiffusersSDXLConfig): The model's config
        submodel_type (None | SubModelType): The submodel type, if any
    """
    ...
    submodel_type: None | SubModelType
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        submodel_type: None | str
        if isinstance(self.submodel_type, SubModelType):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_submodel_type(data: object) -> None | SubModelType:
            if data is None:
                return data
            try:
                ...
                pass
            return cast(None | SubModelType, data)

        submodel_type = _parse_submodel_type(d.pop("submodel_type"))

        model_load_complete_event = cls(
            timestamp=timestamp,
            config=config,
            submodel_type=submodel_type,
        )

        model_load_complete_event.additional_properties = d
        return model_load_complete_event
