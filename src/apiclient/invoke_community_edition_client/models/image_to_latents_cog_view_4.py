...
T = TypeVar("T", bound="ImageToLatentsCogView4")


@_attrs_define
class ImageToLatentsCogView4:
    """Generates latents from an image.

    Attributes:
        id (str): The id of this instance of an invocation. Must be unique among all instances of invocations.
        type_ (Literal['cogview4_i2l']):  Default: 'cogview4_i2l'.
    ...
    id: str
    type_: Literal["cogview4_i2l"] = "cogview4_i2l"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["cogview4_i2l"], d.pop("type"))
        if type_ != "cogview4_i2l":
            raise ValueError(f"type must match const 'cogview4_i2l', got '{type_}'")
        ...
        image_to_latents_cog_view_4 = cls(
            id=id,
            type_=type_,
            board=board,
            metadata=metadata,
        ...
        image_to_latents_cog_view_4.additional_properties = d
        return image_to_latents_cog_view_4
