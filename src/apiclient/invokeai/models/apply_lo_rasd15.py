...
T = TypeVar("T", bound="ApplyLoRASD15")
...
class ApplyLoRASD15:
    ...
    Attributes:
        ...
        type_ (Literal['lora_loader']):  Default: 'lora_loader'.
    ...
    id: str
    type_: Literal["lora_loader"] = "lora_loader"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["lora_loader"], d.pop("type"))
        if type_ != "lora_loader":
            raise ValueError(f"type must match const 'lora_loader', got '{type_}'")
        ...
        apply_lo_rasd15.additional_properties = d
        return apply_lo_rasd15
