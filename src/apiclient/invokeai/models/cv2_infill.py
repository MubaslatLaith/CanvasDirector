...
class CV2Infill:
    ...
    Attributes:
        ...
        type_ (Literal['infill_cv2']):  Default: 'infill_cv2'.
    ...
    id: str
    type_: Literal["infill_cv2"] = "infill_cv2"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["infill_cv2"], d.pop("type"))
        if type_ != "infill_cv2":
            raise ValueError(f"type must match const 'infill_cv2', got '{type_}'")
        ...
        cv2_infill.additional_properties = d
        return cv2_infill
