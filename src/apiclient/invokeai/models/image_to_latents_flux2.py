...
T = TypeVar("T", bound="ImageToLatentsFLUX2")


@_attrs_define
class ImageToLatentsFLUX2:
    """Encodes an image into latents using FLUX.2 Klein's 32-channel VAE.

    Attributes:
        id (str): The id of this instance of an invocation. Must be unique among all instances of invocations.
        type_ (Literal['flux2_vae_encode']):  Default: 'flux2_vae_encode'.
    ...
    id: str
    type_: Literal["flux2_vae_encode"] = "flux2_vae_encode"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["flux2_vae_encode"], d.pop("type"))
        if type_ != "flux2_vae_encode":
            raise ValueError(f"type must match const 'flux2_vae_encode', got '{type_}'")
        ...
        image_to_latents_flux2.additional_properties = d
        return image_to_latents_flux2
