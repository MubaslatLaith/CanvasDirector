...
T = TypeVar("T", bound="VAECheckpointSD2Config")


@_attrs_define
class VAECheckpointSD2Config:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        vae_checkpoint_sd2_config.additional_properties = d
        return vae_checkpoint_sd2_config
