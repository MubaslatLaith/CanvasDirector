...
T = TypeVar("T", bound="ApplyTensorMaskToImage")


@_attrs_define
class ApplyTensorMaskToImage:
    ...
    The image is converted to RGBA and the mask is applied to the alpha channel.
        ...
        Attributes:
            ...
            type_ (Literal['apply_tensor_mask_to_image']):  Default: 'apply_tensor_mask_to_image'.
            ...
            mask (None | TensorField | Unset): The mask tensor to apply.
            image (ImageField | None | Unset): The image to apply the mask to.
            invert (bool | Unset): Whether to invert the mask. Default: False.
    """

    id: str
    type_: Literal["apply_tensor_mask_to_image"] = "apply_tensor_mask_to_image"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["apply_tensor_mask_to_image"], d.pop("type"))
        if type_ != "apply_tensor_mask_to_image":
            raise ValueError(f"type must match const 'apply_tensor_mask_to_image', got '{type_}'")
        ...
        apply_tensor_mask_to_image = cls(
            id=id,
            type_=type_,
            board=board,
            metadata=metadata,
        ...
        apply_tensor_mask_to_image.additional_properties = d
        return apply_tensor_mask_to_image
