...
T = TypeVar("T", bound="Flux2KleinLoRALoaderOutput")


@_attrs_define
class Flux2KleinLoRALoaderOutput:
    ...
    Attributes:
        ...
        type_ (Literal['flux2_klein_lora_loader_output']):  Default: 'flux2_klein_lora_loader_output'.
    """

    transformer: None | TransformerField
    qwen3_encoder: None | Qwen3EncoderField
    type_: Literal["flux2_klein_lora_loader_output"] = "flux2_klein_lora_loader_output"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["flux2_klein_lora_loader_output"], d.pop("type"))
        if type_ != "flux2_klein_lora_loader_output":
            raise ValueError(f"type must match const 'flux2_klein_lora_loader_output', got '{type_}'")

        flux_2_klein_lo_ra_loader_output = cls(
            transformer=transformer,
            qwen3_encoder=qwen3_encoder,
            type_=type_,
        )

        flux_2_klein_lo_ra_loader_output.additional_properties = d
        return flux_2_klein_lo_ra_loader_output
