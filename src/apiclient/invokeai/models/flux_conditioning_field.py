...
T = TypeVar("T", bound="FluxConditioningField")


@_attrs_define
class FluxConditioningField:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        flux_conditioning_field = cls(
            conditioning_name=conditioning_name,
            mask=mask,
        )

        flux_conditioning_field.additional_properties = d
        return flux_conditioning_field
