...
T = TypeVar("T", bound="ModelInstallStartedEvent")


@_attrs_define
class ModelInstallStartedEvent:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        model_install_started_event = cls(
            timestamp=timestamp,
            id=id,
            source=source,
        )

        model_install_started_event.additional_properties = d
        return model_install_started_event
