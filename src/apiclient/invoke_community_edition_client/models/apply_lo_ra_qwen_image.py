...
T = TypeVar("T", bound="ApplyLoRAQwenImage")


@_attrs_define
class ApplyLoRAQwenImage:
    """Apply a LoRA model to a Qwen Image transformer.

    Attributes:
        id (str): The id of this instance of an invocation. Must be unique among all instances of invocations.
        type_ (Literal['qwen_image_lora_loader']):  Default: 'qwen_image_lora_loader'.
        is_intermediate (bool | Unset): Whether or not this is an intermediate invocation. Default: False.
        use_cache (bool | Unset): Whether or not to use the cache Default: True.
        lora (ModelIdentifierField | None | Unset): LoRA model to load
        weight (float | Unset): The weight at which the LoRA is applied to each model Default: 1.0.
        transformer (None | TransformerField | Unset): Transformer
    """

    id: str
    type_: Literal["qwen_image_lora_loader"] = "qwen_image_lora_loader"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["qwen_image_lora_loader"], d.pop("type"))
        if type_ != "qwen_image_lora_loader":
            raise ValueError(f"type must match const 'qwen_image_lora_loader', got '{type_}'")
        ...
        apply_lo_ra_qwen_image.additional_properties = d
        return apply_lo_ra_qwen_image
