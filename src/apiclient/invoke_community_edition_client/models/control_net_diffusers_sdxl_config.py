...
T = TypeVar("T", bound="ControlNetDiffusersSDXLConfig")


@_attrs_define
class ControlNetDiffusersSDXLConfig:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        control_net_diffusers_sdxl_config = cls(
            key=key,
            hash_=hash_,
            path=path,
            file_size=file_size,
        ...
        control_net_diffusers_sdxl_config.additional_properties = d
        return control_net_diffusers_sdxl_config
