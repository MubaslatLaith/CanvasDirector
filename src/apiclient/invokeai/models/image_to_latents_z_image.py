...
T = TypeVar("T", bound="ImageToLatentsZImage")


@_attrs_define
class ImageToLatentsZImage:
    """Generates latents from an image using Z-Image VAE (supports both Diffusers and FLUX VAE).

    Attributes:
        id (str): The id of this instance of an invocation. Must be unique among all instances of invocations.
        type_ (Literal['z_image_i2l']):  Default: 'z_image_i2l'.
    ...
    id: str
    type_: Literal["z_image_i2l"] = "z_image_i2l"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["z_image_i2l"], d.pop("type"))
        if type_ != "z_image_i2l":
            raise ValueError(f"type must match const 'z_image_i2l', got '{type_}'")
        ...
        image_to_latents_z_image.additional_properties = d
        return image_to_latents_z_image
