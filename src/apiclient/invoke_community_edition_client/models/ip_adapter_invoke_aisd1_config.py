...
T = TypeVar("T", bound="IPAdapterInvokeAISD1Config")


@_attrs_define
class IPAdapterInvokeAISD1Config:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ip_adapter_invoke_aisd1_config = cls(
            key=key,
            hash_=hash_,
            path=path,
            file_size=file_size,
        ...
        ip_adapter_invoke_aisd1_config.additional_properties = d
        return ip_adapter_invoke_aisd1_config
