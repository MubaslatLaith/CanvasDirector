...
T = TypeVar("T", bound="AlphaMaskToTensor")
...
class AlphaMaskToTensor:
    ...
    Attributes:
        ...
        type_ (Literal['alpha_mask_to_tensor']):  Default: 'alpha_mask_to_tensor'.
    ...
    id: str
    type_: Literal["alpha_mask_to_tensor"] = "alpha_mask_to_tensor"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["alpha_mask_to_tensor"], d.pop("type"))
        if type_ != "alpha_mask_to_tensor":
            raise ValueError(f"type must match const 'alpha_mask_to_tensor', got '{type_}'")
        ...
        alpha_mask_to_tensor.additional_properties = d
        return alpha_mask_to_tensor
