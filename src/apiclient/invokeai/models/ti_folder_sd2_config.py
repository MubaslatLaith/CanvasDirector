...
T = TypeVar("T", bound="TIFolderSD2Config")


@_attrs_define
class TIFolderSD2Config:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ti_folder_sd2_config.additional_properties = d
        return ti_folder_sd2_config
