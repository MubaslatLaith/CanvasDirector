...
T = TypeVar("T", bound="LoRADiffusersSD1Config")


@_attrs_define
class LoRADiffusersSD1Config:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        lo_ra_diffusers_sd1_config = cls(
            key=key,
            hash_=hash_,
            path=path,
            file_size=file_size,
        ...
        lo_ra_diffusers_sd1_config.additional_properties = d
        return lo_ra_diffusers_sd1_config
