...
T = TypeVar("T", bound="ApplyLoRACollectionZImage")


@_attrs_define
class ApplyLoRACollectionZImage:
    """Applies a collection of LoRAs to a Z-Image transformer.

    Attributes:
        id (str): The id of this instance of an invocation. Must be unique among all instances of invocations.
        type_ (Literal['z_image_lora_collection_loader']):  Default: 'z_image_lora_collection_loader'.
    ...
    id: str
    type_: Literal["z_image_lora_collection_loader"] = "z_image_lora_collection_loader"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["z_image_lora_collection_loader"], d.pop("type"))
        if type_ != "z_image_lora_collection_loader":
            raise ValueError(f"type must match const 'z_image_lora_collection_loader', got '{type_}'")
        ...
        apply_lo_ra_collection_z_image = cls(
            id=id,
            type_=type_,
        ...
        apply_lo_ra_collection_z_image.additional_properties = d
        return apply_lo_ra_collection_z_image
