...
T = TypeVar("T", bound="LoRADiffusersFlux2Config")


@_attrs_define
class LoRADiffusersFlux2Config:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        variant: None | str
        if isinstance(self.variant, Flux2VariantType):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_variant(data: object) -> Flux2VariantType | None:
            if data is None:
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                variant_type_0 = Flux2VariantType(data)

                return variant_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(Flux2VariantType | None, data)

        variant = _parse_variant(d.pop("variant"))

        lo_ra_diffusers_flux_2_config = cls(
            key=key,
            hash_=hash_,
            path=path,
            file_size=file_size,
        ...
        lo_ra_diffusers_flux_2_config.additional_properties = d
        return lo_ra_diffusers_flux_2_config
