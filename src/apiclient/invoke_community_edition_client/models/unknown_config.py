...
T = TypeVar("T", bound="UnknownConfig")
...
class UnknownConfig:
    ...
    Attributes:
        ...
        base (Literal['unknown']):  Default: 'unknown'.
        type_ (Literal['unknown']):  Default: 'unknown'.
        format_ (Literal['unknown']):  Default: 'unknown'.
    """
    ...
    base: Literal["unknown"] = "unknown"
    type_: Literal["unknown"] = "unknown"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        base = cast(Literal["unknown"], d.pop("base"))
        if base != "unknown":
            raise ValueError(f"base must match const 'unknown', got '{base}'")

        type_ = cast(Literal["unknown"], d.pop("type"))
        if type_ != "unknown":
            raise ValueError(f"type must match const 'unknown', got '{type_}'")

        format_ = cast(Literal["unknown"], d.pop("format"))
        if format_ != "unknown":
            raise ValueError(f"format must match const 'unknown', got '{format_}'")
        ...
        unknown_config.additional_properties = d
