...
T = TypeVar("T", bound="AdminUserUpdateRequest")
...
class AdminUserUpdateRequest:
    ...
    Attributes:
        ...
        password (None | str | Unset): New password
        is_admin (bool | None | Unset): Whether user should have admin privileges
        is_active (bool | None | Unset): Whether user account should be active
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        admin_user_update_request.additional_properties = d
        return admin_user_update_request
