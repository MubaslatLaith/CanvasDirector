...
T = TypeVar("T", bound="VAECheckpointSD1Config")


@_attrs_define
class VAECheckpointSD1Config:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        vae_checkpoint_sd1_config.additional_properties = d
        return vae_checkpoint_sd1_config
