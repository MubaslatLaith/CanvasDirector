...
T = TypeVar("T", bound="LoRALyCORISZImageConfig")


@_attrs_define
class LoRALyCORISZImageConfig:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        lo_ra_ly_corisz_image_config = cls(
            key=key,
            hash_=hash_,
            path=path,
            file_size=file_size,
        ...
        lo_ra_ly_corisz_image_config.additional_properties = d
        return lo_ra_ly_corisz_image_config
