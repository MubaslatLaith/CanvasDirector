...
T = TypeVar("T", bound="LatentsToImageZImage")


@_attrs_define
class LatentsToImageZImage:
    """Generates an image from latents using Z-Image VAE (supports both Diffusers and FLUX VAE).

    Attributes:
        id (str): The id of this instance of an invocation. Must be unique among all instances of invocations.
        type_ (Literal['z_image_l2i']):  Default: 'z_image_l2i'.
    ...
    id: str
    type_: Literal["z_image_l2i"] = "z_image_l2i"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["z_image_l2i"], d.pop("type"))
        if type_ != "z_image_l2i":
            raise ValueError(f"type must match const 'z_image_l2i', got '{type_}'")
        ...
        latents_to_image_z_image.additional_properties = d
        return latents_to_image_z_image
