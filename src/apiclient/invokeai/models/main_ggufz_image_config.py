...
T = TypeVar("T", bound="MainGGUFZImageConfig")


@_attrs_define
class MainGGUFZImageConfig:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        main_ggufz_image_config.additional_properties = d
        return main_ggufz_image_config
