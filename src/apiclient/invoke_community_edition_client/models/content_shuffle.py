...
T = TypeVar("T", bound="ContentShuffle")


@_attrs_define
class ContentShuffle:
    """Shuffles the image, similar to a 'liquify' filter.

    Attributes:
        id (str): The id of this instance of an invocation. Must be unique among all instances of invocations.
        type_ (Literal['content_shuffle']):  Default: 'content_shuffle'.
        ...
        scale_factor (int | Unset): The scale factor used for the shuffle Default: 256.
    """

    id: str
    type_: Literal["content_shuffle"] = "content_shuffle"
    board: BoardField | None | Unset = UNSET
    metadata: MetadataField | None | Unset = UNSET
    is_intermediate: bool | Unset = False
    use_cache: bool | Unset = True
    image: ImageField | None | Unset = UNSET
    scale_factor: int | Unset = 256
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["content_shuffle"], d.pop("type"))
        if type_ != "content_shuffle":
            raise ValueError(f"type must match const 'content_shuffle', got '{type_}'")
        ...
        content_shuffle.additional_properties = d
        return content_shuffle
