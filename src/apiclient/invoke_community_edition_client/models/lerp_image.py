...
class LerpImage:
    ...
    Attributes:
        ...
        type_ (Literal['img_lerp']):  Default: 'img_lerp'.
        ...
        min_ (int | Unset): The minimum output value Default: 0.
        max_ (int | Unset): The maximum output value Default: 255.
    """

    id: str
    type_: Literal["img_lerp"] = "img_lerp"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["img_lerp"], d.pop("type"))
        if type_ != "img_lerp":
            raise ValueError(f"type must match const 'img_lerp', got '{type_}'")
        ...
        lerp_image.additional_properties = d
        return lerp_image
