...
T = TypeVar("T", bound="ImageToLatentsSD3")


@_attrs_define
class ImageToLatentsSD3:
    """Generates latents from an image.

    Attributes:
        id (str): The id of this instance of an invocation. Must be unique among all instances of invocations.
        type_ (Literal['sd3_i2l']):  Default: 'sd3_i2l'.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["sd3_i2l"], d.pop("type"))
        if type_ != "sd3_i2l":
            raise ValueError(f"type must match const 'sd3_i2l', got '{type_}'")
        ...
        image_to_latents_sd3.additional_properties = d
        return image_to_latents_sd3
