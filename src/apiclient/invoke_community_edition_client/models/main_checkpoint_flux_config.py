...
T = TypeVar("T", bound="MainCheckpointFLUXConfig")


@_attrs_define
class MainCheckpointFLUXConfig:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        main_checkpoint_flux_config = cls(
            key=key,
            hash_=hash_,
            path=path,
            file_size=file_size,
        ...
        main_checkpoint_flux_config.additional_properties = d
        return main_checkpoint_flux_config
