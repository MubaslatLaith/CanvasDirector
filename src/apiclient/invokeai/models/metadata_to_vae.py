...
from ..models.metadata_to_vae_label import MetadataToVAELabel
...
T = TypeVar("T", bound="MetadataToVAE")
...
class MetadataToVAE:
    ...
    Attributes:
        ...
        type_ (Literal['metadata_to_vae']):  Default: 'metadata_to_vae'.
        metadata (MetadataField | None | Unset): Optional metadata to be saved with the image
        is_intermediate (bool | Unset): Whether or not this is an intermediate invocation. Default: False.
        use_cache (bool | Unset): Whether or not to use the cache Default: True.
        label (MetadataToVAELabel | Unset): Label for this metadata item Default: MetadataToVAELabel.VAE.
        custom_label (None | str | Unset): Label for this metadata item
        default_value (None | Unset | VAEField): The default VAE to use if not found in the metadata
    """

    id: str
    type_: Literal["metadata_to_vae"] = "metadata_to_vae"
    metadata: MetadataField | None | Unset = UNSET
    is_intermediate: bool | Unset = False
    use_cache: bool | Unset = True
    label: MetadataToVAELabel | Unset = MetadataToVAELabel.VAE
    custom_label: None | str | Unset = UNSET
    default_value: None | Unset | VAEField = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.default_value, Unset):
            default_value = UNSET
        elif isinstance(self.default_value, VAEField):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["metadata_to_vae"], d.pop("type"))
        if type_ != "metadata_to_vae":
            raise ValueError(f"type must match const 'metadata_to_vae', got '{type_}'")
        ...
        label: MetadataToVAELabel | Unset
        if isinstance(_label, Unset):
            label = UNSET
        else:
            label = MetadataToVAELabel(_label)
        ...
        def _parse_default_value(data: object) -> None | Unset | VAEField:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                default_value_type_0 = VAEField.from_dict(data)
        ...
        metadata_to_vae.additional_properties = d
        return metadata_to_vae
