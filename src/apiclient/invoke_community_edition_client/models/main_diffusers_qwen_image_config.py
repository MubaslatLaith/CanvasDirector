...
T = TypeVar("T", bound="MainDiffusersQwenImageConfig")


@_attrs_define
class MainDiffusersQwenImageConfig:
    ...
    Attributes:
        ...
        base (Literal['qwen-image']):  Default: 'qwen-image'.
        variant (None | QwenImageVariantType):
    """
    ...
    base: Literal["qwen-image"] = "qwen-image"
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        variant: None | str
        if isinstance(self.variant, QwenImageVariantType):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        base = cast(Literal["qwen-image"], d.pop("base"))
        if base != "qwen-image":
            raise ValueError(f"base must match const 'qwen-image', got '{base}'")

        def _parse_variant(data: object) -> None | QwenImageVariantType:
            if data is None:
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                variant_type_0 = QwenImageVariantType(data)

                return variant_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | QwenImageVariantType, data)

        variant = _parse_variant(d.pop("variant"))

        main_diffusers_qwen_image_config = cls(
            key=key,
            hash_=hash_,
            path=path,
            file_size=file_size,
        ...
        main_diffusers_qwen_image_config.additional_properties = d
        return main_diffusers_qwen_image_config
