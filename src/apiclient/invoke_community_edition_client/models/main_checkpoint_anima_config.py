...
T = TypeVar("T", bound="MainCheckpointAnimaConfig")


@_attrs_define
class MainCheckpointAnimaConfig:
    ...
    that bridges Qwen3 0.6B text encoder outputs to the DiT.
        ...
        Attributes:
            ...
            base (Literal['anima']):  Default: 'anima'.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        base = cast(Literal["anima"], d.pop("base"))
        if base != "anima":
            raise ValueError(f"base must match const 'anima', got '{base}'")
        ...
        main_checkpoint_anima_config = cls(
            key=key,
            hash_=hash_,
            path=path,
            file_size=file_size,
        ...
        main_checkpoint_anima_config.additional_properties = d
        return main_checkpoint_anima_config
