...
T = TypeVar("T", bound="MainDiffusersSD2Config")


@_attrs_define
class MainDiffusersSD2Config:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        main_diffusers_sd2_config.additional_properties = d
        return main_diffusers_sd2_config
