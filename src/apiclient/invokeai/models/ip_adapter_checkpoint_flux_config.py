...
T = TypeVar("T", bound="IPAdapterCheckpointFLUXConfig")


@_attrs_define
class IPAdapterCheckpointFLUXConfig:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ip_adapter_checkpoint_flux_config = cls(
            key=key,
            hash_=hash_,
            path=path,
            file_size=file_size,
        ...
        ip_adapter_checkpoint_flux_config.additional_properties = d
        return ip_adapter_checkpoint_flux_config
