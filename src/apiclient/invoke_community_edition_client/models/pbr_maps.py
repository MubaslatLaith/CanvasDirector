...
from ..models.pbr_maps_border_mode import PBRMapsBorderMode
...
class PBRMaps:
    ...
    Attributes:
        ...
        type_ (Literal['pbr_maps']):  Default: 'pbr_maps'.
        ...
        image (ImageField | None | Unset): Input image
        tile_size (int | Unset): Tile size Default: 512.
        border_mode (PBRMapsBorderMode | Unset): Border mode to apply to eliminate any artifacts or seams Default:
            PBRMapsBorderMode.NONE.
    """

    id: str
    type_: Literal["pbr_maps"] = "pbr_maps"
    ...
    border_mode: PBRMapsBorderMode | Unset = PBRMapsBorderMode.NONE
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        border_mode: str | Unset = UNSET
        if not isinstance(self.border_mode, Unset):
        ...
        if border_mode is not UNSET:
            field_dict["border_mode"] = border_mode
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["pbr_maps"], d.pop("type"))
        if type_ != "pbr_maps":
            raise ValueError(f"type must match const 'pbr_maps', got '{type_}'")
        ...
        _border_mode = d.pop("border_mode", UNSET)
        border_mode: PBRMapsBorderMode | Unset
        if isinstance(_border_mode, Unset):
            border_mode = UNSET
        else:
            border_mode = PBRMapsBorderMode(_border_mode)
        ...
        pbr_maps.additional_properties = d
        return pbr_maps
