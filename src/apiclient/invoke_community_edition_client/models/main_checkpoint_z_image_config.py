...
T = TypeVar("T", bound="MainCheckpointZImageConfig")


@_attrs_define
class MainCheckpointZImageConfig:
    ...
    Attributes:
        ...
        variant (ZImageVariantType): Z-Image model variants.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        variant = ZImageVariantType(d.pop("variant"))

        main_checkpoint_z_image_config = cls(
            key=key,
            hash_=hash_,
            path=path,
            file_size=file_size,
        ...
        main_checkpoint_z_image_config.additional_properties = d
        return main_checkpoint_z_image_config
