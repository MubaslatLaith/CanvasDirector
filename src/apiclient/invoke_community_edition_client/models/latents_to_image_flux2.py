...
T = TypeVar("T", bound="LatentsToImageFLUX2")


@_attrs_define
class LatentsToImageFLUX2:
    """Generates an image from latents using FLUX.2 Klein's 32-channel VAE.

    Attributes:
        id (str): The id of this instance of an invocation. Must be unique among all instances of invocations.
        type_ (Literal['flux2_vae_decode']):  Default: 'flux2_vae_decode'.
    ...
    id: str
    type_: Literal["flux2_vae_decode"] = "flux2_vae_decode"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["flux2_vae_decode"], d.pop("type"))
        if type_ != "flux2_vae_decode":
            raise ValueError(f"type must match const 'flux2_vae_decode', got '{type_}'")
        ...
        latents_to_image_flux2.additional_properties = d
        return latents_to_image_flux2
