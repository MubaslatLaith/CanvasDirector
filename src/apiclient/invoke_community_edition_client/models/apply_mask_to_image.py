...
T = TypeVar("T", bound="ApplyMaskToImage")
...
class ApplyMaskToImage:
    ...
    The mask uses black to indicate areas to keep from the generated image and white for areas to discard.
        ...
        Attributes:
            ...
            type_ (Literal['apply_mask_to_image']):  Default: 'apply_mask_to_image'.
            ...
            image (ImageField | None | Unset): The image from which to extract the masked region
            mask (ImageField | None | Unset): The mask defining the region (black=keep, white=discard)
            invert_mask (bool | Unset): Whether to invert the mask before applying it Default: False.
    """

    id: str
    type_: Literal["apply_mask_to_image"] = "apply_mask_to_image"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["apply_mask_to_image"], d.pop("type"))
        if type_ != "apply_mask_to_image":
            raise ValueError(f"type must match const 'apply_mask_to_image', got '{type_}'")
        ...
        apply_mask_to_image.additional_properties = d
