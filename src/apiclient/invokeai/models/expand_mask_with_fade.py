...
T = TypeVar("T", bound="ExpandMaskWithFade")


@_attrs_define
class ExpandMaskWithFade:
    """Expands a mask with a fade effect. The mask uses black to indicate areas to keep from the generated image and white
    for areas to discard.
    The mask is thresholded to create a binary mask, and then a distance transform is applied to create a fade effect.
    The fade size is specified in pixels, and the mask is expanded by that amount. The result is a mask with a smooth
    transition from black to white.
    If the fade size is 0, the mask is returned as-is.

        Attributes:
            id (str): The id of this instance of an invocation. Must be unique among all instances of invocations.
            type_ (Literal['expand_mask_with_fade']):  Default: 'expand_mask_with_fade'.
            ...
            mask (ImageField | None | Unset): The mask to expand
            threshold (int | Unset): The threshold for the binary mask (0-255) Default: 0.
            fade_size_px (int | Unset): The size of the fade in pixels Default: 32.
    """

    id: str
    type_: Literal["expand_mask_with_fade"] = "expand_mask_with_fade"
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        fade_size_px = self.fade_size_px
        ...
        if fade_size_px is not UNSET:
            field_dict["fade_size_px"] = fade_size_px
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["expand_mask_with_fade"], d.pop("type"))
        if type_ != "expand_mask_with_fade":
            raise ValueError(f"type must match const 'expand_mask_with_fade', got '{type_}'")
        ...
        fade_size_px = d.pop("fade_size_px", UNSET)

        expand_mask_with_fade = cls(
            id=id,
            type_=type_,
            board=board,
            metadata=metadata,
            ...
            mask=mask,
            threshold=threshold,
            fade_size_px=fade_size_px,
        )

        expand_mask_with_fade.additional_properties = d
        return expand_mask_with_fade
