...
from ..models.extract_image_channel_channel import ExtractImageChannelChannel
...
T = TypeVar("T", bound="ExtractImageChannel")
...
class ExtractImageChannel:
    ...
    Attributes:
        ...
        type_ (Literal['img_chan']):  Default: 'img_chan'.
        ...
        image (ImageField | None | Unset): The image to get the channel from
        channel (ExtractImageChannelChannel | Unset): The channel to get Default: ExtractImageChannelChannel.A.
    """

    id: str
    type_: Literal["img_chan"] = "img_chan"
    board: BoardField | None | Unset = UNSET
    metadata: MetadataField | None | Unset = UNSET
    is_intermediate: bool | Unset = False
    use_cache: bool | Unset = True
    image: ImageField | None | Unset = UNSET
    channel: ExtractImageChannelChannel | Unset = ExtractImageChannelChannel.A
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["img_chan"], d.pop("type"))
        if type_ != "img_chan":
            raise ValueError(f"type must match const 'img_chan', got '{type_}'")
        ...
        channel: ExtractImageChannelChannel | Unset
        if isinstance(_channel, Unset):
            channel = UNSET
        else:
            channel = ExtractImageChannelChannel(_channel)

        extract_image_channel = cls(
            id=id,
            type_=type_,
            board=board,
            metadata=metadata,
        ...
        extract_image_channel.additional_properties = d
        return extract_image_channel
