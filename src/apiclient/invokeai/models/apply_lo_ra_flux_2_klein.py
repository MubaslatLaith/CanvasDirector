...
T = TypeVar("T", bound="ApplyLoRAFlux2Klein")


@_attrs_define
class ApplyLoRAFlux2Klein:
    """Apply a LoRA model to a FLUX.2 Klein transformer and/or Qwen3 text encoder.

    Attributes:
        id (str): The id of this instance of an invocation. Must be unique among all instances of invocations.
        type_ (Literal['flux2_klein_lora_loader']):  Default: 'flux2_klein_lora_loader'.
    ...
    id: str
    type_: Literal["flux2_klein_lora_loader"] = "flux2_klein_lora_loader"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["flux2_klein_lora_loader"], d.pop("type"))
        if type_ != "flux2_klein_lora_loader":
            raise ValueError(f"type must match const 'flux2_klein_lora_loader', got '{type_}'")
        ...
        apply_lo_ra_flux_2_klein.additional_properties = d
        return apply_lo_ra_flux_2_klein
