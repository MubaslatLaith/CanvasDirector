...
T = TypeVar("T", bound="LoRALyCORISSD1Config")


@_attrs_define
class LoRALyCORISSD1Config:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        lo_ra_ly_corissd1_config.additional_properties = d
        return lo_ra_ly_corissd1_config
