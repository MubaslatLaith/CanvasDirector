...
T = TypeVar("T", bound="SolidColorInfill")


@_attrs_define
class SolidColorInfill:
    """Infills transparent areas of an image with a solid color

    Attributes:
        id (str): The id of this instance of an invocation. Must be unique among all instances of invocations.
        type_ (Literal['infill_rgba']):  Default: 'infill_rgba'.
    ...
    id: str
    type_: Literal["infill_rgba"] = "infill_rgba"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["infill_rgba"], d.pop("type"))
        if type_ != "infill_rgba":
            raise ValueError(f"type must match const 'infill_rgba', got '{type_}'")
        ...
        solid_color_infill.additional_properties = d
        return solid_color_infill
