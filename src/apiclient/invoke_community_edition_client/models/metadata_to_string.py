...
from ..models.metadata_to_string_label import MetadataToStringLabel
...
T = TypeVar("T", bound="MetadataToString")
...
class MetadataToString:
    ...
    Attributes:
        ...
        type_ (Literal['metadata_to_string']):  Default: 'metadata_to_string'.
        metadata (MetadataField | None | Unset): Optional metadata to be saved with the image
        is_intermediate (bool | Unset): Whether or not this is an intermediate invocation. Default: False.
        use_cache (bool | Unset): Whether or not to use the cache Default: True.
        label (MetadataToStringLabel | Unset): Label for this metadata item Default: MetadataToStringLabel.VALUE_0.
        custom_label (None | str | Unset): Label for this metadata item
        default_value (None | str | Unset): The default string to use if not found in the metadata
    """

    id: str
    type_: Literal["metadata_to_string"] = "metadata_to_string"
    metadata: MetadataField | None | Unset = UNSET
    is_intermediate: bool | Unset = False
    use_cache: bool | Unset = True
    label: MetadataToStringLabel | Unset = MetadataToStringLabel.VALUE_0
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["metadata_to_string"], d.pop("type"))
        if type_ != "metadata_to_string":
            raise ValueError(f"type must match const 'metadata_to_string', got '{type_}'")
        ...
        label: MetadataToStringLabel | Unset
        if isinstance(_label, Unset):
            label = UNSET
        else:
            label = MetadataToStringLabel(_label)
        ...
        metadata_to_string.additional_properties = d
        return metadata_to_string
