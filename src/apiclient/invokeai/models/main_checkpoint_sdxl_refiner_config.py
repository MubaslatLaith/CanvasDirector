...
T = TypeVar("T", bound="MainCheckpointSDXLRefinerConfig")


@_attrs_define
class MainCheckpointSDXLRefinerConfig:
    """
    Attributes:
        ...
        prediction_type (SchedulerPredictionType): Scheduler prediction type.
        variant (ModelVariantType): Variant type.
        base (Literal['sdxl-refiner']):  Default: 'sdxl-refiner'.
    """
    ...
    base: Literal["sdxl-refiner"] = "sdxl-refiner"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        prediction_type = SchedulerPredictionType(d.pop("prediction_type"))

        variant = ModelVariantType(d.pop("variant"))

        base = cast(Literal["sdxl-refiner"], d.pop("base"))
        if base != "sdxl-refiner":
            raise ValueError(f"base must match const 'sdxl-refiner', got '{base}'")

        main_checkpoint_sdxl_refiner_config = cls(
            key=key,
            hash_=hash_,
            path=path,
            file_size=file_size,
        ...
        main_checkpoint_sdxl_refiner_config.additional_properties = d
        return main_checkpoint_sdxl_refiner_config
