...
class UserProfileUpdateRequest:
    ...
    Attributes:
        display_name (None | str | Unset): New display name
        current_password (None | str | Unset): Current password (required when changing password)
        new_password (None | str | Unset): New password
    """
