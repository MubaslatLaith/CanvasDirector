...
T = TypeVar("T", bound="BodyCreateStylePreset")


@_attrs_define
class BodyCreateStylePreset:
    """
    Attributes:
        data (str): The data of the style preset to create
        image (File | None | Unset): The image file to upload
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        body_create_style_preset = cls(
            data=data,
            image=image,
        )

        body_create_style_preset.additional_properties = d
        return body_create_style_preset
