...
T = TypeVar("T", bound="AdjustImageHue")


@_attrs_define
class AdjustImageHue:
    """Adjusts the Hue of an image.

    Attributes:
        id (str): The id of this instance of an invocation. Must be unique among all instances of invocations.
        type_ (Literal['img_hue_adjust']):  Default: 'img_hue_adjust'.
    ...
    id: str
    type_: Literal["img_hue_adjust"] = "img_hue_adjust"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["img_hue_adjust"], d.pop("type"))
        if type_ != "img_hue_adjust":
            raise ValueError(f"type must match const 'img_hue_adjust', got '{type_}'")
        ...
        adjust_image_hue.additional_properties = d
        return adjust_image_hue
