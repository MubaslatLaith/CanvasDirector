...
T = TypeVar("T", bound="LoRALyCORISFLUXConfig")


@_attrs_define
class LoRALyCORISFLUXConfig:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        lo_ra_ly_corisflux_config.additional_properties = d
        return lo_ra_ly_corisflux_config
