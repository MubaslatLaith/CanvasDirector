...
class SelectLoRA:
    ...
    Attributes:
        ...
        type_ (Literal['lora_selector']):  Default: 'lora_selector'.
    ...
    id: str
    type_: Literal["lora_selector"] = "lora_selector"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["lora_selector"], d.pop("type"))
        if type_ != "lora_selector":
            raise ValueError(f"type must match const 'lora_selector', got '{type_}'")
        ...
        select_lo_ra.additional_properties = d
        return select_lo_ra
