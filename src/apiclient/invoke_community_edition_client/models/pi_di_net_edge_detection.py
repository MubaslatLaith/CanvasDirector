...
T = TypeVar("T", bound="PiDiNetEdgeDetection")


@_attrs_define
class PiDiNetEdgeDetection:
    """Generates an edge map using PiDiNet.

    Attributes:
        id (str): The id of this instance of an invocation. Must be unique among all instances of invocations.
        type_ (Literal['pidi_edge_detection']):  Default: 'pidi_edge_detection'.
        ...
        quantize_edges (bool | Unset): Whether or not to use safe mode Default: False.
        scribble (bool | Unset): Whether or not to use scribble mode Default: False.
    """

    id: str
    type_: Literal["pidi_edge_detection"] = "pidi_edge_detection"
    board: BoardField | None | Unset = UNSET
    metadata: MetadataField | None | Unset = UNSET
    is_intermediate: bool | Unset = False
    use_cache: bool | Unset = True
    image: ImageField | None | Unset = UNSET
    quantize_edges: bool | Unset = False
    scribble: bool | Unset = False
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        quantize_edges = self.quantize_edges
        ...
        if quantize_edges is not UNSET:
            field_dict["quantize_edges"] = quantize_edges
        if scribble is not UNSET:
            field_dict["scribble"] = scribble
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["pidi_edge_detection"], d.pop("type"))
        if type_ != "pidi_edge_detection":
            raise ValueError(f"type must match const 'pidi_edge_detection', got '{type_}'")
        ...
        quantize_edges = d.pop("quantize_edges", UNSET)

        scribble = d.pop("scribble", UNSET)

        pi_di_net_edge_detection = cls(
            id=id,
            type_=type_,
            board=board,
            metadata=metadata,
            ...
            use_cache=use_cache,
            image=image,
            quantize_edges=quantize_edges,
            scribble=scribble,
        )

        pi_di_net_edge_detection.additional_properties = d
        return pi_di_net_edge_detection
