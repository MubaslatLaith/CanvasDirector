...
T = TypeVar("T", bound="AdjustImageHueOklch")


@_attrs_define
class AdjustImageHueOklch:
    """Adjusts the hue of an image in Oklch space.

    Attributes:
        id (str): The id of this instance of an invocation. Must be unique among all instances of invocations.
        type_ (Literal['img_hue_adjust_oklch']):  Default: 'img_hue_adjust_oklch'.
        ...
        hue (int | Unset): The degrees by which to rotate the hue, 0-360 Default: 0.
    """

    id: str
    type_: Literal["img_hue_adjust_oklch"] = "img_hue_adjust_oklch"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["img_hue_adjust_oklch"], d.pop("type"))
        if type_ != "img_hue_adjust_oklch":
            raise ValueError(f"type must match const 'img_hue_adjust_oklch', got '{type_}'")
        ...
        adjust_image_hue_oklch.additional_properties = d
        return adjust_image_hue_oklch
