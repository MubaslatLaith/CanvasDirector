...
from ..models.metadata_to_bool_label import MetadataToBoolLabel
...
T = TypeVar("T", bound="MetadataToBool")


@_attrs_define
class MetadataToBool:
    """Extracts a Boolean value of a label from metadata

    Attributes:
        id (str): The id of this instance of an invocation. Must be unique among all instances of invocations.
        type_ (Literal['metadata_to_bool']):  Default: 'metadata_to_bool'.
        metadata (MetadataField | None | Unset): Optional metadata to be saved with the image
        is_intermediate (bool | Unset): Whether or not this is an intermediate invocation. Default: False.
        use_cache (bool | Unset): Whether or not to use the cache Default: True.
        label (MetadataToBoolLabel | Unset): Label for this metadata item Default: MetadataToBoolLabel.VALUE_0.
        custom_label (None | str | Unset): Label for this metadata item
        default_value (bool | None | Unset): The default bool to use if not found in the metadata
    """

    id: str
    type_: Literal["metadata_to_bool"] = "metadata_to_bool"
    metadata: MetadataField | None | Unset = UNSET
    is_intermediate: bool | Unset = False
    use_cache: bool | Unset = True
    label: MetadataToBoolLabel | Unset = MetadataToBoolLabel.VALUE_0
    custom_label: None | str | Unset = UNSET
    default_value: bool | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["metadata_to_bool"], d.pop("type"))
        if type_ != "metadata_to_bool":
            raise ValueError(f"type must match const 'metadata_to_bool', got '{type_}'")
        ...
        label: MetadataToBoolLabel | Unset
        if isinstance(_label, Unset):
            label = UNSET
        else:
            label = MetadataToBoolLabel(_label)
        ...
        def _parse_default_value(data: object) -> bool | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        metadata_to_bool.additional_properties = d
        return metadata_to_bool
