...
from ..models.resize_image_resample_mode import ResizeImageResampleMode
...
class ResizeImage:
    ...
    Attributes:
        ...
        type_ (Literal['img_resize']):  Default: 'img_resize'.
        ...
        resample_mode (ResizeImageResampleMode | Unset): The resampling mode Default: ResizeImageResampleMode.BICUBIC.
    """

    id: str
    type_: Literal["img_resize"] = "img_resize"
    ...
    resample_mode: ResizeImageResampleMode | Unset = ResizeImageResampleMode.BICUBIC
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["img_resize"], d.pop("type"))
        if type_ != "img_resize":
            raise ValueError(f"type must match const 'img_resize', got '{type_}'")
        ...
        resample_mode: ResizeImageResampleMode | Unset
        if isinstance(_resample_mode, Unset):
            resample_mode = UNSET
        else:
            resample_mode = ResizeImageResampleMode(_resample_mode)
        ...
        resize_image.additional_properties = d
        return resize_image
