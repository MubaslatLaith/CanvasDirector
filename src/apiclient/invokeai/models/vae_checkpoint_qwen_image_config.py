...
T = TypeVar("T", bound="VAECheckpointQwenImageConfig")


@_attrs_define
class VAECheckpointQwenImageConfig:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        vae_checkpoint_qwen_image_config = cls(
            key=key,
            hash_=hash_,
            path=path,
            file_size=file_size,
        ...
        vae_checkpoint_qwen_image_config.additional_properties = d
        return vae_checkpoint_qwen_image_config
