...
T = TypeVar("T", bound="MetadataToSDXLLoRAs")


@_attrs_define
class MetadataToSDXLLoRAs:
    """Extracts a SDXL Loras value of a label from metadata

    Attributes:
        id (str): The id of this instance of an invocation. Must be unique among all instances of invocations.
        type_ (Literal['metadata_to_sdlx_loras']):  Default: 'metadata_to_sdlx_loras'.
    ...
    id: str
    type_: Literal["metadata_to_sdlx_loras"] = "metadata_to_sdlx_loras"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["metadata_to_sdlx_loras"], d.pop("type"))
        if type_ != "metadata_to_sdlx_loras":
            raise ValueError(f"type must match const 'metadata_to_sdlx_loras', got '{type_}'")
        ...
        metadata_to_sdxl_lo_r_as.additional_properties = d
        return metadata_to_sdxl_lo_r_as
