...
from ..models.multiply_image_channel_channel_type_0 import MultiplyImageChannelChannelType0
...
T = TypeVar("T", bound="MultiplyImageChannel")


@_attrs_define
class MultiplyImageChannel:
    """Scale a specific color channel of an image.

    Attributes:
        id (str): The id of this instance of an invocation. Must be unique among all instances of invocations.
        type_ (Literal['img_channel_multiply']):  Default: 'img_channel_multiply'.
        ...
        channel (MultiplyImageChannelChannelType0 | None | Unset): Which channel to adjust
        scale (float | Unset): The amount to scale the channel by. Default: 1.0.
        invert_channel (bool | Unset): Invert the channel after scaling Default: False.
    """

    id: str
    type_: Literal["img_channel_multiply"] = "img_channel_multiply"
    board: BoardField | None | Unset = UNSET
    metadata: MetadataField | None | Unset = UNSET
    is_intermediate: bool | Unset = False
    use_cache: bool | Unset = True
    image: ImageField | None | Unset = UNSET
    channel: MultiplyImageChannelChannelType0 | None | Unset = UNSET
    scale: float | Unset = 1.0
    invert_channel: bool | Unset = False
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.channel, Unset):
            channel = UNSET
        elif isinstance(self.channel, MultiplyImageChannelChannelType0):
        ...
        invert_channel = self.invert_channel
        ...
        if invert_channel is not UNSET:
            field_dict["invert_channel"] = invert_channel
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["img_channel_multiply"], d.pop("type"))
        if type_ != "img_channel_multiply":
            raise ValueError(f"type must match const 'img_channel_multiply', got '{type_}'")
        ...
        def _parse_channel(data: object) -> MultiplyImageChannelChannelType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                channel_type_0 = MultiplyImageChannelChannelType0(data)

                return channel_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(MultiplyImageChannelChannelType0 | None | Unset, data)

        channel = _parse_channel(d.pop("channel", UNSET))

        scale = d.pop("scale", UNSET)

        invert_channel = d.pop("invert_channel", UNSET)

        multiply_image_channel = cls(
            id=id,
            type_=type_,
            board=board,
            metadata=metadata,
        ...
        multiply_image_channel.additional_properties = d
        return multiply_image_channel
