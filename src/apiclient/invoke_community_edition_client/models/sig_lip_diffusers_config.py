...
T = TypeVar("T", bound="SigLIPDiffusersConfig")


@_attrs_define
class SigLIPDiffusersConfig:
    ...
    Attributes:
        ...
        type_ (Literal['siglip']):  Default: 'siglip'.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["siglip"], d.pop("type"))
        if type_ != "siglip":
            raise ValueError(f"type must match const 'siglip', got '{type_}'")
        ...
        sig_lip_diffusers_config.additional_properties = d
        return sig_lip_diffusers_config
