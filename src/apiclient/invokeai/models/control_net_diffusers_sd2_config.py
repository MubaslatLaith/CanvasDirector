...
T = TypeVar("T", bound="ControlNetDiffusersSD2Config")


@_attrs_define
class ControlNetDiffusersSD2Config:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        control_net_diffusers_sd2_config = cls(
            key=key,
            hash_=hash_,
            path=path,
            file_size=file_size,
        ...
        control_net_diffusers_sd2_config.additional_properties = d
        return control_net_diffusers_sd2_config
