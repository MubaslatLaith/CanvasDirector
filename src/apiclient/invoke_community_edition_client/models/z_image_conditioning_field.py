...
T = TypeVar("T", bound="ZImageConditioningField")


@_attrs_define
class ZImageConditioningField:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        z_image_conditioning_field = cls(
            conditioning_name=conditioning_name,
            mask=mask,
        )

        z_image_conditioning_field.additional_properties = d
        return z_image_conditioning_field
