...
T = TypeVar("T", bound="VAEDiffusersSDXLConfig")


@_attrs_define
class VAEDiffusersSDXLConfig:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        vae_diffusers_sdxl_config.additional_properties = d
        return vae_diffusers_sdxl_config
