...
T = TypeVar("T", bound="ZImageLoRALoaderOutput")


@_attrs_define
class ZImageLoRALoaderOutput:
    ...
    Attributes:
        ...
        type_ (Literal['z_image_lora_loader_output']):  Default: 'z_image_lora_loader_output'.
    """

    transformer: None | TransformerField
    qwen3_encoder: None | Qwen3EncoderField
    type_: Literal["z_image_lora_loader_output"] = "z_image_lora_loader_output"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["z_image_lora_loader_output"], d.pop("type"))
        if type_ != "z_image_lora_loader_output":
            raise ValueError(f"type must match const 'z_image_lora_loader_output', got '{type_}'")

        z_image_lo_ra_loader_output = cls(
            transformer=transformer,
            qwen3_encoder=qwen3_encoder,
            type_=type_,
        )

        z_image_lo_ra_loader_output.additional_properties = d
        return z_image_lo_ra_loader_output
