...
T = TypeVar("T", bound="MainDiffusersCogView4Config")


@_attrs_define
class MainDiffusersCogView4Config:
    """
    Attributes:
        ...
        base (Literal['cogview4']):  Default: 'cogview4'.
    """
    ...
    base: Literal["cogview4"] = "cogview4"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        base = cast(Literal["cogview4"], d.pop("base"))
        if base != "cogview4":
            raise ValueError(f"base must match const 'cogview4', got '{base}'")

        main_diffusers_cog_view_4_config = cls(
            key=key,
            hash_=hash_,
            path=path,
            file_size=file_size,
        ...
        main_diffusers_cog_view_4_config.additional_properties = d
        return main_diffusers_cog_view_4_config
