...
class DenoiseSD3:
    ...
    Attributes:
        ...
        type_ (Literal['sd3_denoise']):  Default: 'sd3_denoise'.
        ...
        transformer (None | TransformerField | Unset): SD3 model (MMDiTX) to load
        positive_conditioning (None | SD3ConditioningField | Unset): Positive conditioning tensor
        negative_conditioning (None | SD3ConditioningField | Unset): Negative conditioning tensor
    ...
    id: str
    type_: Literal["sd3_denoise"] = "sd3_denoise"
    ...
    positive_conditioning: None | SD3ConditioningField | Unset = UNSET
    negative_conditioning: None | SD3ConditioningField | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.positive_conditioning, SD3ConditioningField):
        ...
        elif isinstance(self.negative_conditioning, SD3ConditioningField):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["sd3_denoise"], d.pop("type"))
        if type_ != "sd3_denoise":
            raise ValueError(f"type must match const 'sd3_denoise', got '{type_}'")
        ...
        def _parse_positive_conditioning(data: object) -> None | SD3ConditioningField | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                positive_conditioning_type_0 = SD3ConditioningField.from_dict(data)

                return positive_conditioning_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | SD3ConditioningField | Unset, data)

        positive_conditioning = _parse_positive_conditioning(d.pop("positive_conditioning", UNSET))

        def _parse_negative_conditioning(data: object) -> None | SD3ConditioningField | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                negative_conditioning_type_0 = SD3ConditioningField.from_dict(data)
        ...
        denoise_sd3.additional_properties = d
        return denoise_sd3
