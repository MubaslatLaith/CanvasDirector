...
T = TypeVar("T", bound="BulkDownloadErrorEvent")


@_attrs_define
class BulkDownloadErrorEvent:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bulk_download_error_event.additional_properties = d
        return bulk_download_error_event
