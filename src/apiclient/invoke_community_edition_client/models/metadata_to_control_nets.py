...
T = TypeVar("T", bound="MetadataToControlNets")


@_attrs_define
class MetadataToControlNets:
    """Extracts a Controlnets value of a label from metadata

    Attributes:
        id (str): The id of this instance of an invocation. Must be unique among all instances of invocations.
        type_ (Literal['metadata_to_controlnets']):  Default: 'metadata_to_controlnets'.
        metadata (MetadataField | None | Unset): Optional metadata to be saved with the image
        is_intermediate (bool | Unset): Whether or not this is an intermediate invocation. Default: False.
        use_cache (bool | Unset): Whether or not to use the cache Default: True.
        control_list (ControlField | list[ControlField] | None | Unset):
    """

    id: str
    type_: Literal["metadata_to_controlnets"] = "metadata_to_controlnets"
    metadata: MetadataField | None | Unset = UNSET
    is_intermediate: bool | Unset = False
    use_cache: bool | Unset = True
    control_list: ControlField | list[ControlField] | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        control_list: dict[str, Any] | list[dict[str, Any]] | None | Unset
        if isinstance(self.control_list, Unset):
            control_list = UNSET
        elif isinstance(self.control_list, ControlField):
        ...
        if control_list is not UNSET:
            field_dict["control_list"] = control_list
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["metadata_to_controlnets"], d.pop("type"))
        if type_ != "metadata_to_controlnets":
            raise ValueError(f"type must match const 'metadata_to_controlnets', got '{type_}'")
        ...
        def _parse_control_list(data: object) -> ControlField | list[ControlField] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        control_list = _parse_control_list(d.pop("control_list", UNSET))

        metadata_to_control_nets = cls(
            id=id,
            type_=type_,
            metadata=metadata,
        ...
        metadata_to_control_nets.additional_properties = d
        return metadata_to_control_nets
