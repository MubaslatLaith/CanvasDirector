...
T = TypeVar("T", bound="LineartEdgeDetection")


@_attrs_define
class LineartEdgeDetection:
    """Generates an edge map using the Lineart model.

    Attributes:
        id (str): The id of this instance of an invocation. Must be unique among all instances of invocations.
        type_ (Literal['lineart_edge_detection']):  Default: 'lineart_edge_detection'.
        ...
        coarse (bool | Unset): Whether to use coarse mode Default: False.
    """

    id: str
    type_: Literal["lineart_edge_detection"] = "lineart_edge_detection"
    board: BoardField | None | Unset = UNSET
    metadata: MetadataField | None | Unset = UNSET
    is_intermediate: bool | Unset = False
    use_cache: bool | Unset = True
    image: ImageField | None | Unset = UNSET
    coarse: bool | Unset = False
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if coarse is not UNSET:
            field_dict["coarse"] = coarse
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["lineart_edge_detection"], d.pop("type"))
        if type_ != "lineart_edge_detection":
            raise ValueError(f"type must match const 'lineart_edge_detection', got '{type_}'")
        ...
        coarse = d.pop("coarse", UNSET)

        lineart_edge_detection = cls(
            id=id,
            type_=type_,
            board=board,
            metadata=metadata,
        ...
        lineart_edge_detection.additional_properties = d
        return lineart_edge_detection
