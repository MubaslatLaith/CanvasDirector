...
if TYPE_CHECKING:
    ...
    from ..models.model_install_download_started_event_parts_item import ModelInstallDownloadStartedEventPartsItem
    from ..models.url_model_source import URLModelSource


T = TypeVar("T", bound="ModelInstallDownloadStartedEvent")


@_attrs_define
class ModelInstallDownloadStartedEvent:
    ...
    Attributes:
        ...
        parts (list[ModelInstallDownloadStartedEventPartsItem]): Progress of downloading URLs that comprise the model,
            if any
    """
    ...
    bytes_: int
    total_bytes: int
    parts: list[ModelInstallDownloadStartedEventPartsItem]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for parts_item_data in _parts:
            parts_item = ModelInstallDownloadStartedEventPartsItem.from_dict(parts_item_data)

            parts.append(parts_item)

        model_install_download_started_event = cls(
            timestamp=timestamp,
            id=id,
            source=source,
            local_path=local_path,
        ...
        model_install_download_started_event.additional_properties = d
        return model_install_download_started_event
