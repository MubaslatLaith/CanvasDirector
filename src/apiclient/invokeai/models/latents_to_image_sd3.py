...
T = TypeVar("T", bound="LatentsToImageSD3")


@_attrs_define
class LatentsToImageSD3:
    """Generates an image from latents.

    Attributes:
        id (str): The id of this instance of an invocation. Must be unique among all instances of invocations.
        type_ (Literal['sd3_l2i']):  Default: 'sd3_l2i'.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["sd3_l2i"], d.pop("type"))
        if type_ != "sd3_l2i":
            raise ValueError(f"type must match const 'sd3_l2i', got '{type_}'")
        ...
        latents_to_image_sd3.additional_properties = d
        return latents_to_image_sd3
