...
T = TypeVar("T", bound="VAECheckpointSDXLConfig")


@_attrs_define
class VAECheckpointSDXLConfig:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        vae_checkpoint_sdxl_config = cls(
            key=key,
            hash_=hash_,
            path=path,
            file_size=file_size,
        ...
        vae_checkpoint_sdxl_config.additional_properties = d
        return vae_checkpoint_sdxl_config
