...
T = TypeVar("T", bound="FaceIdentifier")
...
class FaceIdentifier:
    ...
    Attributes:
        ...
        type_ (Literal['face_identifier']):  Default: 'face_identifier'.
    ...
    id: str
    type_: Literal["face_identifier"] = "face_identifier"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["face_identifier"], d.pop("type"))
        if type_ != "face_identifier":
            raise ValueError(f"type must match const 'face_identifier', got '{type_}'")
        ...
        face_identifier.additional_properties = d
