...
T = TypeVar("T", bound="T5EncoderT5EncoderConfig")


@_attrs_define
class T5EncoderT5EncoderConfig:
    ...
    a folder called text_encoder_2 inside the model directory, with a config file named model.safetensors.index.json.
        ...
        Attributes:
            ...
            format_ (Literal['t5_encoder']):  Default: 't5_encoder'.
    ...
    format_: Literal["t5_encoder"] = "t5_encoder"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        format_ = cast(Literal["t5_encoder"], d.pop("format"))
        if format_ != "t5_encoder":
            raise ValueError(f"format must match const 't5_encoder', got '{format_}'")
        ...
        t5_encoder_t5_encoder_config = cls(
            key=key,
            hash_=hash_,
            path=path,
            file_size=file_size,
        ...
        t5_encoder_t5_encoder_config.additional_properties = d
        return t5_encoder_t5_encoder_config
