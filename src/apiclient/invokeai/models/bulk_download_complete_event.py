...
T = TypeVar("T", bound="BulkDownloadCompleteEvent")


@_attrs_define
class BulkDownloadCompleteEvent:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bulk_download_complete_event = cls(
            timestamp=timestamp,
            bulk_download_id=bulk_download_id,
            bulk_download_item_id=bulk_download_item_id,
            bulk_download_item_name=bulk_download_item_name,
        ...
        bulk_download_complete_event.additional_properties = d
        return bulk_download_complete_event
