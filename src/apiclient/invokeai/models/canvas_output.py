...
T = TypeVar("T", bound="CanvasOutput")
...
class CanvasOutput:
    ...
    to the canvas staging area when run via 'Run Workflow on Canvas'.
        ...
        Attributes:
            ...
            type_ (Literal['canvas_output']):  Default: 'canvas_output'.
    ...
    id: str
    type_: Literal["canvas_output"] = "canvas_output"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["canvas_output"], d.pop("type"))
        if type_ != "canvas_output":
            raise ValueError(f"type must match const 'canvas_output', got '{type_}'")
        ...
        canvas_output.additional_properties = d
