...
T = TypeVar("T", bound="T2IAdapterDiffusersSDXLConfig")


@_attrs_define
class T2IAdapterDiffusersSDXLConfig:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        t2i_adapter_diffusers_sdxl_config = cls(
            key=key,
            hash_=hash_,
            path=path,
            file_size=file_size,
        ...
        t2i_adapter_diffusers_sdxl_config.additional_properties = d
        return t2i_adapter_diffusers_sdxl_config
