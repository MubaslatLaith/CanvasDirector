...
class StringJoin:
    ...
    Attributes:
        ...
        type_ (Literal['string_join']):  Default: 'string_join'.
    ...
    id: str
    type_: Literal["string_join"] = "string_join"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["string_join"], d.pop("type"))
        if type_ != "string_join":
            raise ValueError(f"type must match const 'string_join', got '{type_}'")
        ...
        string_join.additional_properties = d
        return string_join
