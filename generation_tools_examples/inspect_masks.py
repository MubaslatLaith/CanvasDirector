...
print('invokeai mask')
inspect_mask(valid_mask) 

print('sam3 postprocessed mask') 
sam3_postprocessed_mask = Image.open('/workspace/CanvasDirector/sam3_mask0.png')
inspect_mask(sam3_postprocessed_mask) 
