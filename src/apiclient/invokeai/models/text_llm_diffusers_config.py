...
T = TypeVar("T", bound="TextLLMDiffusersConfig")


@_attrs_define
class TextLLMDiffusersConfig:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        text_llm_diffusers_config.additional_properties = d
        return text_llm_diffusers_config
