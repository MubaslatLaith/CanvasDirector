...
class FaceOff:
    ...
    Attributes:
        ...
        type_ (Literal['face_off']):  Default: 'face_off'.
        metadata (MetadataField | None | Unset): Optional metadata to be saved with the image
        is_intermediate (bool | Unset): Whether or not this is an intermediate invocation. Default: False.
        use_cache (bool | Unset): Whether or not to use the cache Default: True.
        image (ImageField | None | Unset): Image for face detection
        face_id (int | Unset): The face ID to process, numbered from 0. Multiple faces not supported. Find a face's ID
            with FaceIdentifier node. Default: 0.
        minimum_confidence (float | Unset): Minimum confidence for face detection (lower if detection is failing)
            Default: 0.5.
        x_offset (float | Unset): X-axis offset of the mask Default: 0.0.
        y_offset (float | Unset): Y-axis offset of the mask Default: 0.0.
        padding (int | Unset): All-axis padding around the mask in pixels Default: 0.
    ...
    id: str
    type_: Literal["face_off"] = "face_off"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["face_off"], d.pop("type"))
        if type_ != "face_off":
            raise ValueError(f"type must match const 'face_off', got '{type_}'")
        ...
        face_off.additional_properties = d
        return face_off
