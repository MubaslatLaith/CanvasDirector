...
T = TypeVar("T", bound="ApplyLoRAZImage")


@_attrs_define
class ApplyLoRAZImage:
    """Apply a LoRA model to a Z-Image transformer and/or Qwen3 text encoder.

    Attributes:
        id (str): The id of this instance of an invocation. Must be unique among all instances of invocations.
        type_ (Literal['z_image_lora_loader']):  Default: 'z_image_lora_loader'.
    ...
    id: str
    type_: Literal["z_image_lora_loader"] = "z_image_lora_loader"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["z_image_lora_loader"], d.pop("type"))
        if type_ != "z_image_lora_loader":
            raise ValueError(f"type must match const 'z_image_lora_loader', got '{type_}'")
        ...
        apply_lo_raz_image.additional_properties = d
        return apply_lo_raz_image
