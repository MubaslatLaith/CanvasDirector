...
T = TypeVar("T", bound="ImageToLatentsQwenImage")


@_attrs_define
class ImageToLatentsQwenImage:
    """Generates latents from an image using the Qwen Image VAE.

    Attributes:
        id (str): The id of this instance of an invocation. Must be unique among all instances of invocations.
        type_ (Literal['qwen_image_i2l']):  Default: 'qwen_image_i2l'.
        ...
        width (int | None | Unset): Resize the image to this width before encoding. If not set, encodes at the image's
            original size.
        height (int | None | Unset): Resize the image to this height before encoding. If not set, encodes at the image's
            original size.
    """

    id: str
    type_: Literal["qwen_image_i2l"] = "qwen_image_i2l"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["qwen_image_i2l"], d.pop("type"))
        if type_ != "qwen_image_i2l":
            raise ValueError(f"type must match const 'qwen_image_i2l', got '{type_}'")
        ...
        image_to_latents_qwen_image = cls(
            id=id,
            type_=type_,
            board=board,
            metadata=metadata,
        ...
        image_to_latents_qwen_image.additional_properties = d
        return image_to_latents_qwen_image
