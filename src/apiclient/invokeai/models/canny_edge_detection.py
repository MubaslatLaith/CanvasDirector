...
T = TypeVar("T", bound="CannyEdgeDetection")
...
class CannyEdgeDetection:
    ...
    Attributes:
        ...
        type_ (Literal['canny_edge_detection']):  Default: 'canny_edge_detection'.
        ...
        low_threshold (int | Unset): The low threshold of the Canny pixel gradient (0-255) Default: 100.
        high_threshold (int | Unset): The high threshold of the Canny pixel gradient (0-255) Default: 200.
    """

    id: str
    type_: Literal["canny_edge_detection"] = "canny_edge_detection"
    board: BoardField | None | Unset = UNSET
    metadata: MetadataField | None | Unset = UNSET
    is_intermediate: bool | Unset = False
    use_cache: bool | Unset = True
    image: ImageField | None | Unset = UNSET
    low_threshold: int | Unset = 100
    high_threshold: int | Unset = 200
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["canny_edge_detection"], d.pop("type"))
        if type_ != "canny_edge_detection":
            raise ValueError(f"type must match const 'canny_edge_detection', got '{type_}'")
        ...
        canny_edge_detection.additional_properties = d
