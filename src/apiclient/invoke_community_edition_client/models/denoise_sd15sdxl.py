...
from ..models.denoise_sd15sdxl_scheduler import DenoiseSD15SDXLScheduler
...
T = TypeVar("T", bound="DenoiseSD15SDXL")


@_attrs_define
class DenoiseSD15SDXL:
    """Denoises noisy latents to decodable images

    Attributes:
        id (str): The id of this instance of an invocation. Must be unique among all instances of invocations.
        type_ (Literal['denoise_latents']):  Default: 'denoise_latents'.
        ...
        scheduler (DenoiseSD15SDXLScheduler | Unset): Scheduler to use during inference Default:
            DenoiseSD15SDXLScheduler.EULER.
    ...
    id: str
    type_: Literal["denoise_latents"] = "denoise_latents"
    ...
    scheduler: DenoiseSD15SDXLScheduler | Unset = DenoiseSD15SDXLScheduler.EULER
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["denoise_latents"], d.pop("type"))
        if type_ != "denoise_latents":
            raise ValueError(f"type must match const 'denoise_latents', got '{type_}'")
        ...
        scheduler: DenoiseSD15SDXLScheduler | Unset
        if isinstance(_scheduler, Unset):
            scheduler = UNSET
        else:
            scheduler = DenoiseSD15SDXLScheduler(_scheduler)
        ...
        denoise_sd15sdxl.additional_properties = d
        return denoise_sd15sdxl
