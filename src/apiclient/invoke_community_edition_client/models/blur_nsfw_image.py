...
T = TypeVar("T", bound="BlurNSFWImage")
...
class BlurNSFWImage:
    ...
    Attributes:
        ...
        type_ (Literal['img_nsfw']):  Default: 'img_nsfw'.
    ...
    id: str
    type_: Literal["img_nsfw"] = "img_nsfw"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["img_nsfw"], d.pop("type"))
        if type_ != "img_nsfw":
            raise ValueError(f"type must match const 'img_nsfw', got '{type_}'")
        ...
        blur_nsfw_image.additional_properties = d
        return blur_nsfw_image
