...
T = TypeVar("T", bound="MainDiffusersSDXLConfig")


@_attrs_define
class MainDiffusersSDXLConfig:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        main_diffusers_sdxl_config = cls(
            key=key,
            hash_=hash_,
            path=path,
            file_size=file_size,
        ...
        main_diffusers_sdxl_config.additional_properties = d
