...
T = TypeVar("T", bound="MLSDDetection")
...
class MLSDDetection:
    ...
    Attributes:
        ...
        type_ (Literal['mlsd_detection']):  Default: 'mlsd_detection'.
        ...
        score_threshold (float | Unset): The threshold used to score points when determining line segments Default: 0.1.
        distance_threshold (float | Unset): Threshold for including a line segment - lines shorter than this distance
            will be discarded Default: 20.0.
    """

    id: str
    type_: Literal["mlsd_detection"] = "mlsd_detection"
    ...
    distance_threshold: float | Unset = 20.0
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["mlsd_detection"], d.pop("type"))
        if type_ != "mlsd_detection":
            raise ValueError(f"type must match const 'mlsd_detection', got '{type_}'")
        ...
        distance_threshold = d.pop("distance_threshold", UNSET)
        ...
        mlsd_detection.additional_properties = d
        return mlsd_detection
