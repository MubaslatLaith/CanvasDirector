...
T = TypeVar("T", bound="ModelLoadStartedEvent")


@_attrs_define
class ModelLoadStartedEvent:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        model_load_started_event = cls(
            timestamp=timestamp,
            config=config,
            submodel_type=submodel_type,
        )

        model_load_started_event.additional_properties = d
        return model_load_started_event
