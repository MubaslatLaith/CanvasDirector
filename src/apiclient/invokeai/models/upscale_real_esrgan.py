...
from ..models.upscale_real_esrgan_model_name import UpscaleRealESRGANModelName
...
T = TypeVar("T", bound="UpscaleRealESRGAN")


@_attrs_define
class UpscaleRealESRGAN:
    """Upscales an image using RealESRGAN.

    Attributes:
        id (str): The id of this instance of an invocation. Must be unique among all instances of invocations.
        type_ (Literal['esrgan']):  Default: 'esrgan'.
        ...
        model_name (UpscaleRealESRGANModelName | Unset): The Real-ESRGAN model to use Default:
            UpscaleRealESRGANModelName.REALESRGAN_X4PLUS_PTH.
        tile_size (int | Unset): Tile size for tiled ESRGAN upscaling (0=tiling disabled) Default: 400.
    """

    id: str
    type_: Literal["esrgan"] = "esrgan"
    board: BoardField | None | Unset = UNSET
    metadata: MetadataField | None | Unset = UNSET
    is_intermediate: bool | Unset = False
    use_cache: bool | Unset = True
    image: ImageField | None | Unset = UNSET
    model_name: UpscaleRealESRGANModelName | Unset = UpscaleRealESRGANModelName.REALESRGAN_X4PLUS_PTH
    tile_size: int | Unset = 400
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["esrgan"], d.pop("type"))
        if type_ != "esrgan":
            raise ValueError(f"type must match const 'esrgan', got '{type_}'")
        ...
        model_name: UpscaleRealESRGANModelName | Unset
        if isinstance(_model_name, Unset):
            model_name = UNSET
        else:
            model_name = UpscaleRealESRGANModelName(_model_name)

        tile_size = d.pop("tile_size", UNSET)

        upscale_real_esrgan = cls(
            id=id,
            type_=type_,
            board=board,
            metadata=metadata,
        ...
        upscale_real_esrgan.additional_properties = d
        return upscale_real_esrgan
