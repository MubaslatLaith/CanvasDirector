...
from ..models.seedream_image_generation_mode import SeedreamImageGenerationMode
...
T = TypeVar("T", bound="SeedreamImageGeneration")


@_attrs_define
class SeedreamImageGeneration:
    """Generate images using a BytePlus Seedream model.

    Attributes:
        id (str): The id of this instance of an invocation. Must be unique among all instances of invocations.
        type_ (Literal['seedream_image_generation']):  Default: 'seedream_image_generation'.
        ...
        mode (SeedreamImageGenerationMode | Unset): Generation mode. Default: SeedreamImageGenerationMode.TXT2IMG.
        ...
        watermark (bool | Unset): Add watermark to generated images Default: False.
        optimize_prompt (bool | Unset): Let the model optimize the prompt before generation Default: False.
    """

    id: str
    type_: Literal["seedream_image_generation"] = "seedream_image_generation"
    ...
    mode: SeedreamImageGenerationMode | Unset = SeedreamImageGenerationMode.TXT2IMG
    ...
    watermark: bool | Unset = False
    optimize_prompt: bool | Unset = False
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if optimize_prompt is not UNSET:
            field_dict["optimize_prompt"] = optimize_prompt
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["seedream_image_generation"], d.pop("type"))
        if type_ != "seedream_image_generation":
            raise ValueError(f"type must match const 'seedream_image_generation', got '{type_}'")
        ...
        mode: SeedreamImageGenerationMode | Unset
        if isinstance(_mode, Unset):
            mode = UNSET
        else:
            mode = SeedreamImageGenerationMode(_mode)
        ...
        optimize_prompt = d.pop("optimize_prompt", UNSET)

        seedream_image_generation = cls(
            id=id,
            type_=type_,
            board=board,
            metadata=metadata,
        ...
        seedream_image_generation.additional_properties = d
        return seedream_image_generation
