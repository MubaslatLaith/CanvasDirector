...
T = TypeVar("T", bound="AddInvisibleWatermark")


@_attrs_define
class AddInvisibleWatermark:
    """Add an invisible watermark to an image

    Attributes:
        id (str): The id of this instance of an invocation. Must be unique among all instances of invocations.
        type_ (Literal['img_watermark']):  Default: 'img_watermark'.
        ...
        image (ImageField | None | Unset): The image to check
        text (str | Unset): Watermark text Default: 'InvokeAI'.
    """

    id: str
    type_: Literal["img_watermark"] = "img_watermark"
    board: BoardField | None | Unset = UNSET
    metadata: MetadataField | None | Unset = UNSET
    is_intermediate: bool | Unset = False
    use_cache: bool | Unset = True
    image: ImageField | None | Unset = UNSET
    text: str | Unset = "InvokeAI"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["img_watermark"], d.pop("type"))
        if type_ != "img_watermark":
            raise ValueError(f"type must match const 'img_watermark', got '{type_}'")
        ...
        add_invisible_watermark.additional_properties = d
