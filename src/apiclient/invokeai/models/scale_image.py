...
from ..models.scale_image_resample_mode import ScaleImageResampleMode
...
class ScaleImage:
    ...
    Attributes:
        ...
        type_ (Literal['img_scale']):  Default: 'img_scale'.
        ...
        image (ImageField | None | Unset): The image to scale
        scale_factor (float | Unset): The factor by which to scale the image Default: 2.0.
        resample_mode (ScaleImageResampleMode | Unset): The resampling mode Default: ScaleImageResampleMode.BICUBIC.
    """

    id: str
    type_: Literal["img_scale"] = "img_scale"
    board: BoardField | None | Unset = UNSET
    metadata: MetadataField | None | Unset = UNSET
    is_intermediate: bool | Unset = False
    use_cache: bool | Unset = True
    image: ImageField | None | Unset = UNSET
    scale_factor: float | Unset = 2.0
    resample_mode: ScaleImageResampleMode | Unset = ScaleImageResampleMode.BICUBIC
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["img_scale"], d.pop("type"))
        if type_ != "img_scale":
            raise ValueError(f"type must match const 'img_scale', got '{type_}'")
        ...
        scale_factor = d.pop("scale_factor", UNSET)

        _resample_mode = d.pop("resample_mode", UNSET)
        resample_mode: ScaleImageResampleMode | Unset
        if isinstance(_resample_mode, Unset):
            resample_mode = UNSET
        else:
            resample_mode = ScaleImageResampleMode(_resample_mode)
        ...
        scale_image.additional_properties = d
        return scale_image
