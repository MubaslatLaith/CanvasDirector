...
class SaveImage:
    ...
    Attributes:
        ...
        type_ (Literal['save_image']):  Default: 'save_image'.
    ...
    id: str
    type_: Literal["save_image"] = "save_image"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["save_image"], d.pop("type"))
        if type_ != "save_image":
            raise ValueError(f"type must match const 'save_image', got '{type_}'")
        ...
        save_image.additional_properties = d
        return save_image
