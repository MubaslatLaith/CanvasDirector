...
from ..models.gemini_image_generation_mode import GeminiImageGenerationMode
from ..models.gemini_image_generation_thinking_level_type_0 import GeminiImageGenerationThinkingLevelType0
...
T = TypeVar("T", bound="GeminiImageGeneration")
...
class GeminiImageGeneration:
    ...
    Attributes:
        ...
        type_ (Literal['gemini_image_generation']):  Default: 'gemini_image_generation'.
        ...
        mode (GeminiImageGenerationMode | Unset): Generation mode. Default: GeminiImageGenerationMode.TXT2IMG.
        ...
        thinking_level (GeminiImageGenerationThinkingLevelType0 | None | Unset): Thinking level for image generation
    """

    id: str
    type_: Literal["gemini_image_generation"] = "gemini_image_generation"
    ...
    mode: GeminiImageGenerationMode | Unset = GeminiImageGenerationMode.TXT2IMG
    ...
    thinking_level: GeminiImageGenerationThinkingLevelType0 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.thinking_level, GeminiImageGenerationThinkingLevelType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["gemini_image_generation"], d.pop("type"))
        if type_ != "gemini_image_generation":
            raise ValueError(f"type must match const 'gemini_image_generation', got '{type_}'")
        ...
        mode: GeminiImageGenerationMode | Unset
        if isinstance(_mode, Unset):
            mode = UNSET
        else:
            mode = GeminiImageGenerationMode(_mode)
        ...
        def _parse_thinking_level(data: object) -> GeminiImageGenerationThinkingLevelType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                thinking_level_type_0 = GeminiImageGenerationThinkingLevelType0(data)

                return thinking_level_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(GeminiImageGenerationThinkingLevelType0 | None | Unset, data)

        thinking_level = _parse_thinking_level(d.pop("thinking_level", UNSET))

        gemini_image_generation = cls(
            id=id,
            type_=type_,
            board=board,
            metadata=metadata,
        ...
        gemini_image_generation.additional_properties = d
