...
class TileInfill:
    ...
    Attributes:
        ...
        type_ (Literal['infill_tile']):  Default: 'infill_tile'.
        ...
        tile_size (int | Unset): The tile size (px) Default: 32.
        seed (int | Unset): The seed to use for tile generation (omit for random) Default: 0.
    """

    id: str
    type_: Literal["infill_tile"] = "infill_tile"
    board: BoardField | None | Unset = UNSET
    metadata: MetadataField | None | Unset = UNSET
    is_intermediate: bool | Unset = False
    use_cache: bool | Unset = True
    image: ImageField | None | Unset = UNSET
    tile_size: int | Unset = 32
    seed: int | Unset = 0
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["infill_tile"], d.pop("type"))
        if type_ != "infill_tile":
            raise ValueError(f"type must match const 'infill_tile', got '{type_}'")
        ...
        tile_infill.additional_properties = d
        return tile_infill
