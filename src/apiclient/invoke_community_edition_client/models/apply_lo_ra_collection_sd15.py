...
T = TypeVar("T", bound="ApplyLoRACollectionSD15")


@_attrs_define
class ApplyLoRACollectionSD15:
    """Applies a collection of LoRAs to the provided UNet and CLIP models.

    Attributes:
        id (str): The id of this instance of an invocation. Must be unique among all instances of invocations.
        type_ (Literal['lora_collection_loader']):  Default: 'lora_collection_loader'.
    ...
    id: str
    type_: Literal["lora_collection_loader"] = "lora_collection_loader"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["lora_collection_loader"], d.pop("type"))
        if type_ != "lora_collection_loader":
            raise ValueError(f"type must match const 'lora_collection_loader', got '{type_}'")
        ...
        apply_lo_ra_collection_sd15 = cls(
            id=id,
            type_=type_,
        ...
        apply_lo_ra_collection_sd15.additional_properties = d
        return apply_lo_ra_collection_sd15
