...
T = TypeVar("T", bound="VAEDiffusersFlux2Config")


@_attrs_define
class VAEDiffusersFlux2Config:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        vae_diffusers_flux_2_config = cls(
            key=key,
            hash_=hash_,
            path=path,
            file_size=file_size,
        ...
        vae_diffusers_flux_2_config.additional_properties = d
        return vae_diffusers_flux_2_config
