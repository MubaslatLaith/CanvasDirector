...
T = TypeVar("T", bound="LoRAOMIFLUXConfig")


@_attrs_define
class LoRAOMIFLUXConfig:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        lo_raomiflux_config.additional_properties = d
        return lo_raomiflux_config
