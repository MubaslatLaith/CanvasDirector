...
from ..models.convert_image_mode_mode import ConvertImageModeMode
...
T = TypeVar("T", bound="ConvertImageMode")
...
class ConvertImageMode:
    ...
    Attributes:
        ...
        type_ (Literal['img_conv']):  Default: 'img_conv'.
        ...
        image (ImageField | None | Unset): The image to convert
        mode (ConvertImageModeMode | Unset): The mode to convert to Default: ConvertImageModeMode.L.
    """

    id: str
    type_: Literal["img_conv"] = "img_conv"
    board: BoardField | None | Unset = UNSET
    metadata: MetadataField | None | Unset = UNSET
    is_intermediate: bool | Unset = False
    use_cache: bool | Unset = True
    image: ImageField | None | Unset = UNSET
    mode: ConvertImageModeMode | Unset = ConvertImageModeMode.L
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["img_conv"], d.pop("type"))
        if type_ != "img_conv":
            raise ValueError(f"type must match const 'img_conv', got '{type_}'")
        ...
        mode: ConvertImageModeMode | Unset
        if isinstance(_mode, Unset):
            mode = UNSET
        else:
            mode = ConvertImageModeMode(_mode)

        convert_image_mode = cls(
            id=id,
            type_=type_,
            board=board,
            metadata=metadata,
        ...
        convert_image_mode.additional_properties = d
