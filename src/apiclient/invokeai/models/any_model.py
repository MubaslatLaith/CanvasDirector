...
class AnyModel:
    ...
    error.
        ...
        Attributes:
            ...
            type_ (Literal['model_identifier']):  Default: 'model_identifier'.
            is_intermediate (bool | Unset): Whether or not this is an intermediate invocation. Default: False.
            use_cache (bool | Unset): Whether or not to use the cache Default: True.
            model (ModelIdentifierField | None | Unset): The model to select
    """

    id: str
    type_: Literal["model_identifier"] = "model_identifier"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["model_identifier"], d.pop("type"))
        if type_ != "model_identifier":
            raise ValueError(f"type must match const 'model_identifier', got '{type_}'")
        ...
        any_model.additional_properties = d
        return any_model
