...
class PasteImage:
    ...
    Attributes:
        ...
        type_ (Literal['img_paste']):  Default: 'img_paste'.
        ...
        base_image (ImageField | None | Unset): The base image
        image (ImageField | None | Unset): The image to paste
        mask (ImageField | None | Unset): The mask to use when pasting
        x (int | Unset): The left x coordinate at which to paste the image Default: 0.
        y (int | Unset): The top y coordinate at which to paste the image Default: 0.
        crop (bool | Unset): Crop to base image dimensions Default: False.
    """

    id: str
    type_: Literal["img_paste"] = "img_paste"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["img_paste"], d.pop("type"))
        if type_ != "img_paste":
            raise ValueError(f"type must match const 'img_paste', got '{type_}'")
        ...
        paste_image.additional_properties = d
        return paste_image
