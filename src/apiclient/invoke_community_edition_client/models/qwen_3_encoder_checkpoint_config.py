...
T = TypeVar("T", bound="Qwen3EncoderCheckpointConfig")


@_attrs_define
class Qwen3EncoderCheckpointConfig:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        qwen_3_encoder_checkpoint_config = cls(
            key=key,
            hash_=hash_,
            path=path,
            file_size=file_size,
        ...
        qwen_3_encoder_checkpoint_config.additional_properties = d
        return qwen_3_encoder_checkpoint_config
