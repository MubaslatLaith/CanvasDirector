...
T = TypeVar("T", bound="WorkflowRecordWithThumbnailDTO")


@_attrs_define
class WorkflowRecordWithThumbnailDTO:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        workflow_record_with_thumbnail_dto = cls(
            workflow_id=workflow_id,
            name=name,
            created_at=created_at,
            updated_at=updated_at,
        ...
        workflow_record_with_thumbnail_dto.additional_properties = d
        return workflow_record_with_thumbnail_dto
