...
class CropImage:
    ...
    Attributes:
        ...
        type_ (Literal['img_crop']):  Default: 'img_crop'.
        ...
        x (int | Unset): The left x coordinate of the crop rectangle Default: 0.
        y (int | Unset): The top y coordinate of the crop rectangle Default: 0.
        width (int | Unset): The width of the crop rectangle Default: 512.
        height (int | Unset): The height of the crop rectangle Default: 512.
    """

    id: str
    type_: Literal["img_crop"] = "img_crop"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["img_crop"], d.pop("type"))
        if type_ != "img_crop":
            raise ValueError(f"type must match const 'img_crop', got '{type_}'")
        ...
        crop_image.additional_properties = d
        return crop_image
