...
T = TypeVar("T", bound="ModelInstallDownloadsCompleteEvent")


@_attrs_define
class ModelInstallDownloadsCompleteEvent:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        model_install_downloads_complete_event = cls(
            timestamp=timestamp,
            id=id,
            source=source,
        )

        model_install_downloads_complete_event.additional_properties = d
        return model_install_downloads_complete_event
