...
T = TypeVar("T", bound="LineartAnimeEdgeDetection")


@_attrs_define
class LineartAnimeEdgeDetection:
    """Geneartes an edge map using the Lineart model.

    Attributes:
        id (str): The id of this instance of an invocation. Must be unique among all instances of invocations.
        type_ (Literal['lineart_anime_edge_detection']):  Default: 'lineart_anime_edge_detection'.
    ...
    id: str
    type_: Literal["lineart_anime_edge_detection"] = "lineart_anime_edge_detection"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["lineart_anime_edge_detection"], d.pop("type"))
        if type_ != "lineart_anime_edge_detection":
            raise ValueError(f"type must match const 'lineart_anime_edge_detection', got '{type_}'")
        ...
        lineart_anime_edge_detection = cls(
            id=id,
            type_=type_,
            board=board,
            metadata=metadata,
        ...
        lineart_anime_edge_detection.additional_properties = d
        return lineart_anime_edge_detection
