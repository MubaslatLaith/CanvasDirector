...
class NormalMap:
    ...
    Attributes:
        ...
        type_ (Literal['normal_map']):  Default: 'normal_map'.
    ...
    id: str
    type_: Literal["normal_map"] = "normal_map"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["normal_map"], d.pop("type"))
        if type_ != "normal_map":
            raise ValueError(f"type must match const 'normal_map', got '{type_}'")
        ...
        normal_map.additional_properties = d
        return normal_map
