...
T = TypeVar("T", bound="ControlNetCheckpointZImageConfig")


@_attrs_define
class ControlNetCheckpointZImageConfig:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        control_net_checkpoint_z_image_config = cls(
            key=key,
            hash_=hash_,
            path=path,
            file_size=file_size,
        ...
        control_net_checkpoint_z_image_config.additional_properties = d
        return control_net_checkpoint_z_image_config
