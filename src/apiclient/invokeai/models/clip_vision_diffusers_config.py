...
T = TypeVar("T", bound="CLIPVisionDiffusersConfig")


@_attrs_define
class CLIPVisionDiffusersConfig:
    ...
    Attributes:
        ...
        type_ (Literal['clip_vision']):  Default: 'clip_vision'.
    ...
    type_: Literal["clip_vision"] = "clip_vision"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = cast(Literal["clip_vision"], d.pop("type"))
        if type_ != "clip_vision":
            raise ValueError(f"type must match const 'clip_vision', got '{type_}'")
        ...
        clip_vision_diffusers_config = cls(
            key=key,
            hash_=hash_,
            path=path,
            file_size=file_size,
        ...
        clip_vision_diffusers_config.additional_properties = d
        return clip_vision_diffusers_config
